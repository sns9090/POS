...
namespace POS.Acc
{
    public partial class Acc_Tran_Q : BaseForm
    {
       ...
       // DataTable dtg;
        ...
        string a_ref, a_type,acc,conkey;
        ...
        private void dataGridView1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.KeyCode == Keys.F8 && dataGridView1.ReadOnly==false)
                {
                    ...
                    Search_All f4 = new Search_All("1", "Acc2");
                    f4.ShowDialog();
...
/*
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    daml.SqlCon_Open();
                    int exexcuted = daml.Insert_Update_Delete_retrn_int("INSERT INTO acc_hdr(a_brno,a_type,a_ref,a_mdate, a_hdate,a_text,a_amt,a_entries,mainkey,usrid,jhsrc,serial_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + comboBox1.SelectedValue + "'," + ref_max + ",'" + mdate + "','" + hdate + "','" + txt_desc.Text + "'," + txt_amt.Text + "," + (dataGridView1.RowCount - 1) + ",'" + txt_key.Text + "','" + txt_user.Text + "','Acc2','" + txt_bookno.Text + "','"+txt_ccno.Text+"')", false);
                    daml.SqlCon_Close();
                    if (exexcuted > 0)
                    {
                ...
                using (SqlCommand cmd = new SqlCommand("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_camt, a_damt, a_folio,a_mdate,a_hdate,jddbcr,cc_no) VALUES(@a0,@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10,@a11)", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@a6", txt_amt.Text);
    ...
    */
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!dthdr.Rows[0][8].ToString().Equals("Acc2"))
                {
                ...
                if (btn_Post.Enabled == true)
                {
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        if (string.Equals(row.Cells[0].Value as string, txt_key.Text))
                            dataGridView1.Rows.Remove(row);
                    }
                    dataGridView1.AllowUserToAddRows = true;
                }
        ...
        private void btn_Del_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    ////}
                    int exexcuted = daml.Insert_Update_Delete_retrn_int("delete from acc_hdr where a_posted=0 and a_ref=" + txt_ref.Text + " and a_type='" + comboBox1.SelectedValue + "'", false);
        ...
        private void Fill_Data(string atype, string aref)
        {
            try
            {
              ...
              //  hdate = txt_hdate.Text.Replace("-", "").Substring(4, 4) + txt_hdate.Text.Replace("-", "").Substring(2, 2) + txt_hdate.Text.Replace("-", "").Substring(0, 2);
                ...
                dtdtl = daml.SELECT_QUIRY_only_retrn_dt("select aa.a_key a_key,bb.a_name a_name,aa.a_text a_text,aa.a_damt a_damt,aa.a_camt a_camt  from acc_dtl aa,accounts bb where aa.a_key=bb.a_key and aa.a_type='" + atype + "' and aa.a_ref=" + aref + " and aa.a_brno='" + BL.CLS_Session.brno + "' order by aa.a_folio");
        ...
        {
            DataTable dt = daml.SELECT_QUIRY_only_retrn_dt("select a_name from accounts where a_key='" + txt_key.Text + "' and a_brno='" + BL.CLS_Session.brno + "'" + conkey + "");
            // dataGridView1.DataSource = daml.SELECT_QUIRY(qstr2);
