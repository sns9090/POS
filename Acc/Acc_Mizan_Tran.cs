...
namespace POS.Acc
{
    public partial class Acc_Mizan_Tran : BaseForm
    {
                        ...
                        */
                        ...
                        if (numericUpDown1.Value == 4)
                        {
                            qstr = "select a.a_key d1,a.a_name d2,"
                                //  + " round((case when a.a_opnbal > 0  then a.a_opnbal else 0 end),2) + (select isnull(sum(b.a_damt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where a.a_key=b.a_key) d3"
                                //       + " ,round((case when a.a_opnbal < 0  then -a.a_opnbal else 0 end),2) + (select isnull(sum(-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where a.a_key=b.a_key) d4"
                                     ...
                                     + " ,case when (select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where a.a_key=b.a_key) > 0 then (select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where a.a_key=b.a_key) else 0 end d7"
                                     ...
                                     + " from accounts a where (select round(0 +isnull(count(*),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " where a.a_key=b.a_key) <>0 " + condallbr + " and len(a.a_key)=9"
                                     + " order by a.a_key;";
                        }
                        else
                        {
                            string condallbr2 = chk_allbr.Checked ? " " : " and b.a_brno='" + BL.CLS_Session.brno + "' ";
                            int keylen = numericUpDown1.Value == 3 ? 6 : numericUpDown1.Value == 2 ? 4 : 2;
                            qstr = "select a.a_key d1,a.a_name d2,"
                                //   + " round((case when a.a_opnbal > 0  then a.a_opnbal else 0 end),2) + (select isnull(sum(b.a_damt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") d3"
                                //   + ", round((case when a.a_opnbal < 0  then -a.a_opnbal else 0 end),2) + (select isnull(sum(-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') "+condallbr2+") d4"
                                    + " (select round(isnull(sum(b.a_damt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") d5"
                                    + " ,(select round(isnull(sum(b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") d6"
                                    + " ,case when (select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") > 0 then (select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") else 0 end d7"
                                    + " ,case when (select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") < 0 then -(select round(0 + isnull(sum(b.a_damt-b.a_camt),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate between '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") else 0 end d8"

                                    + " from accounts a where (select round(0 +isnull(count(*),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") <>0 and len(a.a_key)=" + keylen + ""
                                    + " order by a.a_key;";
                        }
                        dtm = daml.SELECT_QUIRY_only_retrn_dt(qstr);
                      ...
                      //  int keylen = numericUpDown1.Value == 3 ? 6 : numericUpDown1.Value == 2 ? 4 : 2;
                        qstr = qstr + " union all " + "select a.a_key d1,a.a_name d2,"
                            ...
                            //   + ", round((case when a.a_opnbal < 0  then -a.a_opnbal else 0 end),2) + (select isnull(sum(-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') "+condallbr2+") d4"
                                ...
                                + " from accounts a where (select round(0 +isnull(count(*),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") <>0 and len(a.a_key)=" + 6 + ""
                            // + " order by a.a_key;";
                               ;
                        qstr = qstr + " union all " + "select a.a_key d1,a.a_name d2,"
                            //   + " round((case when a.a_opnbal > 0  then a.a_opnbal else 0 end),2) + (select isnull(sum(b.a_damt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") d3"
                            //   + ", round((case when a.a_opnbal < 0  then -a.a_opnbal else 0 end),2) + (select isnull(sum(-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') "+condallbr2+") d4"
                                   ...
                                   + " from accounts a where (select round(0 +isnull(count(*),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") <>0 and len(a.a_key)=" + 4 + ""
                            // + " order by a.a_key;";
                                  ;
                        qstr = qstr + " union all " + "select a.a_key d1,a.a_name d2,"
                            //   + " round((case when a.a_opnbal > 0  then a.a_opnbal else 0 end),2) + (select isnull(sum(b.a_damt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") d3"
                            //   + ", round((case when a.a_opnbal < 0  then -a.a_opnbal else 0 end),2) + (select isnull(sum(-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate < '" + datval.convert_to_yyyyDDdd(txt_fmdate.Text) + "' where b.a_key like CONCAT(a.a_key, '%') "+condallbr2+") d4"
                                   ...
                                   + " from accounts a where (select round(0 +isnull(count(*),0),4) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " where b.a_key like CONCAT(a.a_key, '%') " + condallbr2 + ") <>0 and len(a.a_key)=" + 2 + ""
                                   + " order by a.a_key;";
        ...
        private void Load_Statment3()
        {
            try
            {
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; ++i)
                {
                    ...
                    dataGridView1.Rows[i].Cells[5].Value = Convert.ToDouble(dataGridView1.Rows[i].Cells[3].Value.ToString().Trim());
                    dataGridView1.Rows[i].Cells[4].Value = Convert.ToDouble(dataGridView1.Rows[i].Cells[2].Value.ToString().Trim());
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Acc.rpt.Acc_Mizan_Tran_rpt.rdlc";
                ...
                parameters[2] = new ReportParameter("desc", radioButton1.Checked? "ميزان مراجعة حركات مجاميع" : "ميزان مراجعة حركات ارصدة");
