...
namespace POS.Acc
{
    public partial class Acc_Final_Report_mm : BaseForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          //  MessageBox.Show(datval.convert_to_yyyyDDdd(txt_tmdate.Text));
                ...
                try
                {
                    ...
                    if (chk_ak.Checked || chk_m.Checked)
                    {
                        ...
                        string qstr = "select a.a_key s,a.a_name d"
                                   ...
                                   + " from accounts a  join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key "
                        ...
                        string qstr = "select a.a_key s,a.a_name d"
                                 + " ,round(a.a_opnbal+isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) f"
                                 + " ,round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2) g"
                                 + " from accounts a  join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + ""
                                 + " where a.a_brno='" + BL.CLS_Session.brno + "' and a.glcurrency<>'01' and a.a_type in('2')"
                                 + " group by a.a_key,a.a_name,a.a_opnbal"
                                 + " having round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<>0"
                                 + " order by a.a_key ";
                        */
                        ...
                        ////////         + " ,round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2) g"
                        //string qstr = "select a.a_key s,a.a_name d"
                        //       + " ,iif((round((case when a.a_opnbal<0 then -a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round((case when a.a_opnbal>0 then a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2))>0,(round((case when a.a_opnbal<0 then -a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round((case when a.a_opnbal>0 then a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2)),0) f"
                        //       + " ,iif((round((case when a.a_opnbal<0 then -a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round((case when a.a_opnbal>0 then a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2))<0,-(round((case when a.a_opnbal<0 then -a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round((case when a.a_opnbal>0 then a.a_opnbal else 0.00 end)+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2)),0) g"
                        //         + " from accounts a  join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " and " + (chk_date.Checked ? " c.a_hdate" : " c.a_mdate") + "<='" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' "
                        ...
                        //      //   + " where a.a_brno='" + BL.CLS_Session.brno + "' and a.glcurrency<>'01' and a.a_type in('2')"
                        //         + " where a.a_type in('2') " + condallbr + " and len(a.a_key)=9"
                        //         + " group by a.a_key,a.a_name,a.a_opnbal"
                        //         + " having round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<>0"
                        //         + " order by a.a_key ";
                        string qstr = "select a.a_key s,a.a_name d"
                        ...
                        if (chk_ak.Checked)
                        {
                            ...
                            //         + " where a.a_type in('3') " + condallbr + " and len(a.a_key)=9"
                            //         + " group by a.a_key,a.a_name,a.a_opnbal"
                            //         + " having round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<>0"
                            //         + " order by a.a_key ";
                    ...
                    if (chk_mm.Checked)
                    {
                        ...
                        ////////    //    + " from accounts a join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate <= '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' "
                        //string qstr = "select a.a_key s,a.a_name d"
                        //       + " ,iif((round(isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2))>0,(round(isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2)),0) f"
                        //       + " ,iif((round(isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2))<0,-(round(isnull(sum(case b.jddbcr when 'C'then b.a_camt else 0 end),0),2) - "
                        //       + " round(a.a_opnbal+isnull(sum(case b.jddbcr when 'D'then b.a_damt else 0 end),0),2)),0) g"
                        ...
                        //      //   + " where a.a_brno='" + BL.CLS_Session.brno + "' and a.glcurrency<>'01' and a.a_type in('2')"
                        //         + " where a.a_type in('1') " + condallbr + " and len(a.a_key)=9"
                        //         + " group by a.a_key,a.a_name,a.a_opnbal"
                        //         + " having round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<>0"
                        //         + " order by a.a_key ";
                        string qstr = "select a.a_key s,a.a_name d"
                              + " ,iif(round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)>0,round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2),0.00) f"
                              + " ,iif(round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<0,-round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2),0.00) g"
                                + " from accounts a left outer join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key left outer join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no " + condp + " and " + (chk_date.Checked ? " c.a_hdate" : " c.a_mdate") + "<='" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' "
                            //    + " from accounts a join acc_dtl b on a.a_brno=b.a_brno and a.a_key=b.a_key join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type " + condp + " and c.a_mdate <= '" + datval.convert_to_yyyyDDdd(txt_tmdate.Text) + "' "
                        ...
                        if (!BL.CLS_Session.is_dorymost.Equals("2"))
                        {
                            ...
                            //dr0[2] = Convert.ToDouble(txt_mkhzon.Text) < 0 ? Convert.ToDouble(txt_mkhzon.Text) * -1 : 0;
                            //dr0[3] = Convert.ToDouble(txt_mkhzon.Text) > 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0;
                          //  dr0[2] = Convert.ToDouble(txt_mkhzon.Text) < 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0;// Convert.ToDouble(txt_mkhzon.Text);
                            dr0[3] = Convert.ToDouble(txt_mkhzon.Text) < 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0;
                            dr0[2] = Convert.ToDouble(txt_mkhzon.Text) > 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0; // Convert.ToDouble(txt_mkhzon.Text) > 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0;
                            // dr[4] = sumtrd;
                            // dr[5] = sumtrm;
                            // dr[6] = sumttld;
                            // dr[7] = sumttlm;
                       ...
                       * DataRow dr2 = dtf.NewRow();
                       ...
                       // dataGridView1.Rows[0].DefaultCellStyle.BackColor = sumnet > 0 ? Color.LightGreen : sumnet < 0 ? Color.Pink : Color.SkyBlue;
                       // dataGridView1.Rows[dataGridView1.Rows.Count - 3].DefaultCellStyle.BackColor = Color.LightGreen;
                        dataGridView1.Rows[dataGridView1.Rows.Count - 2].DefaultCellStyle.BackColor = Color.LightGreen;// Color.LightSteelBlue;
                        dataGridView1.Rows[dataGridView1.Rows.Count - 1].DefaultCellStyle.BackColor = Color.LightSteelBlue;// sumnet < 0 ? Color.LightGreen : sumnet > 0 ? Color.Red : Color.SkyBlue;
                        dataGridView1.ClearSelection();
                    }
                    if (rd_tshqil.Checked)
                    {
                        string condallbr = chk_allbr.Checked ? " " : " and a.a_brno='" + BL.CLS_Session.brno + "' ";
                        string condp = rad_posted.Checked ? " and c.a_posted=1 " : (rad_notpostd.Checked ? " and c.a_posted=0 " : " ");
                        // string conft= " a.a_opnbal "
                        ...
                        //      //   + " where a.a_brno='" + BL.CLS_Session.brno + "' and a.glcurrency<>'01' and a.a_type in('2')"
                        //         + " where a.a_type in('0') " + condallbr + " and len(a.a_key)=9"
                        //         + " group by a.a_key,a.a_name,a.a_opnbal"
                        //         + " having round(a.a_opnbal + isnull(sum(case b.jddbcr when 'D' then b.a_damt else -(b.a_camt) end),0),2)<>0"
                        //         + " order by a.a_key ";
                        string qstr = "select a.a_key s,a.a_name d"
                        ...
                        ////    dr0[3] = 0;// Convert.ToDouble(txt_mkhzon.Text) > 0 ? Convert.ToDouble(txt_mkhzon.Text) : 0;
                        ////    // dr[4] = sumtrd;
                        ////    // dr[5] = sumtrm;
                        ////    // dr[6] = sumttld;
                        ////    // dr[7] = sumttlm;
                      ...
                      //  dataGridView1.Rows[dataGridView1.Rows.Count - 1].DefaultCellStyle.BackColor = sumnet > 0 ? Color.LightGreen : sumnet < 0 ? Color.Red : Color.SkyBlue;
                        dataGridView1.ClearSelection();
                    }
        ...
        private void SalesReport_Load(object sender, EventArgs e)
        {
           ...
           // //               + " from accounts a  join acc_dtl b on a.a_comp=b.a_comp and a.a_key=b.a_key and a.glcurrency=b.jdcurr"
           // //               + " and b.a_key<>''"
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // parameters[3] = new ReportParameter("todate", maskedTextBox2.Text);
                ...
                parameters[2] = new ReportParameter("rpt_type", this.Text + " - " +( chk_m.Checked ? chk_m.Text : chk_ak.Checked ? chk_ak.Text : chk_mm.Text));
