...
namespace POS.Acc
{
    public partial class CC_Statment_Exp : BaseForm
    {
        ...
        public CC_Statment_Exp(string akey)
        {
            InitializeComponent();
