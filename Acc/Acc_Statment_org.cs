      ...
      //  DataTable dtt;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
               ...
               // workSheet.Range["A" + (dataGridView1.Rows.Count + 5).ToString(), "I" + (dataGridView1.Rows.Count + 5).ToString()].AutoFormat(Microsoft.Office.Interop.Excel.XlRangeAutoFormat.xlRangeAutoFormat3DEffects2);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = datval.convert_dtg_to_dt(dataGridView1);
            ...
            if (aakey != "")
            {
                try
                {
                    ...
                    */
                    ...
                    string qstr2 = "select a.a_type c1,a.a_ref c2,CONVERT(VARCHAR(10), CAST(a.a_mdate as date), 105) c3,CONVERT(VARCHAR(10), CAST(a.a_hdate as date), 105) c9,a.a_text c4,round((case a.jddbcr when 'C' then a.a_camt else 0 end),2) c5,round((case a.jddbcr when 'D' then a.a_damt else 0 end),2) c6,b.a_posted,a.a_type a_t,b.jhsrc src from acc_dtl a,acc_hdr b  where a.a_brno=b.a_brno and a.a_ref=b.a_ref and a.a_type=b.a_type and " + condp + " and " + cond + " <= '" + txt_tdate.Text.Replace("-", "") + "' and a.a_key='" + aakey + "' and a.a_brno='" + BL.CLS_Session.brno + "' order by a.a_mdate,a.a_sysdate";
                    dth = daml.SELECT_QUIRY_only_retrn_dt("select a_name,round(a_opnbal,2) a_opnbal,a_key from accounts where a_key='" + aakey + "' and a_brno='" + BL.CLS_Session.brno + "'" + conkey + "");
                    if (dth.Rows.Count > 0)
        ...
        private void txt_fdate_Layout(object sender, LayoutEventArgs e)
        {
            try
            {
        ...
        Acc.rpt.Acc_frmPrint xx = new Acc.rpt.Acc_frmPrint();
        private void ExportToFile(object sender)
        {
            try
            {
               
              //  var x = Acc.rpt.Acc_frmPrint. ReportViewer.LocalReport.ListRenderingExtensions();
                var x =xx.reportViewer1.LocalReport.ListRenderingExtensions();
                ...
                if (render_ != null)
                {
                  //  var DialogResult = ReportViewer.ExportDialog(render_);
                    var DialogResult = xx.reportViewer1.ExportDialog(render_);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           // ReportViewer.Invoke(new ExportTo(ExportToFile), new object[] { sender });
            xx.reportViewer1.Invoke(new ExportTo(ExportToFile), new object[] { sender });
        }
