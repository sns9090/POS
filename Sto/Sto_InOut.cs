...
namespace POS.Sto
{
    public partial class Sto_InOut : BaseForm
    {
        ...
        DataTable dthdr, dtdtl, dt222, dtunits, dtsal, dtvat, dttrtyps, dtslctr, accdthdr;
        string a_slctr, a_ref, a_type, strcash, strrcash, strrcrdt, strcrdt, strdsc, strtax, strcashr, stwhno, sttowhno, stmkhzon, stcstcode, inoutacc,dbtoco, brtoco;
        bool isnew, isupdate, notposted,pricnocost;
       ...
       // SqlConnection contoco;
        public Sto_InOut(string slctr, string atype, string aref)
        {
            InitializeComponent();
            ...
            try
            {
                if (e.KeyCode == Keys.F8 && dataGridView1.ReadOnly==false)
                {
                    ...
                    try
                    {
                        ...
                        dataGridView1.CurrentRow.Cells[10].Value = dt222.Rows[0]["item_price"];
        ...
        private void dataGridView1_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.CurrentCell == dataGridView1[6, dataGridView1.CurrentRow.Index] || dataGridView1.CurrentCell == dataGridView1[11, dataGridView1.CurrentRow.Index])//.ReadOnly == true || dataGridView1[3, dataGridView1.CurrentRow.Index].ReadOnly == true || dataGridView1[6, dataGridView1.CurrentRow.Index].ReadOnly == true)
                {
        ...
        private void Acc_Tran_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (BL.CLS_Session.is_dorymost.Equals("2"))
                 //   if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                {
                ...
                try
                {
                    ...
                    ////else
                    ////{
                    dttrtyps = daml.SELECT_QUIRY_only_retrn_dt("select * from trtypes where tr_no in(" + tr + ") and tr_no in('31','32','35')");
                    ...
                    */
                    ...
                    // MessageBox.Show(sl);
                    dtslctr = daml.SELECT_QUIRY_only_retrn_dt("select wh_no,wh_name,mkhzon_acc,cstcode,frq_sar_acc from whouses where wh_brno + wh_no in(" + sl + ") and wh_brno='" + BL.CLS_Session.brno + "'");
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               // if ((BL.CLS_Session.is_dorymost.Equals("2") && ((txt_key.Visible == true && txt_key.Text == "") || (txt_key.Visible == true && txt_name.Text == ""))))
              ...
              //  jrdacc = Convert.ToInt32(dt2.Rows[0][0]) + 1;
                ...
                {
                    daml.SqlCon_Open();
                   // int exexcuteds = daml.Insert_Update_Delete_retrn_int("INSERT INTO sto_hdr(branch,trtype,ref,trmdate, trhdate,text,remarks,entries,amnttl,costttl,usrid,supno,whno,towhno,stkjvno) "
                    int exexcuteds = daml.Insert_Update_Delete_retrn_int("INSERT INTO sto_hdr(branch,trtype,ref,trmdate, trhdate,text,remarks,entries,amnttl,costttl,usrid,supno,whno,towhno,stkjvno) "
                                  //  + " VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + ref_max + ",'" + mdate + "','" + hdate + "','" + txt_desc.Text + "','" + txt_remark.Text + "'," + (dataGridView1.RowCount - 1) + "," + txt_total.Text + "," + txt_cost.Text + ",'" + txt_user.Text + "','" + txt_custno.Text + "','" + cmb_ftwh.SelectedValue + "','" + cmb_ftwh.SelectedValue + "'," +  jrdacc  + ")", false);
                                   + " VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + ref_max + ",'" + mdate + "','" + hdate + "','" + txt_desc.Text + "','" + txt_remark.Text + "'," + (dataGridView1.RowCount - 1) + "," + txt_total.Text + "," + txt_cost.Text + ",'" + txt_user.Text + "','" + txt_custno.Text + "','" + cmb_ftwh.SelectedValue + "','" + cmb_ftwh.SelectedValue + "'," +  0  + ")", false);
                    daml.SqlCon_Close();
                    //daml.SqlCon_Open();
                ...
                {
                    daml.SqlCon_Open();
                    int exexcuteds = daml.Insert_Update_Delete_retrn_int("update sto_hdr set trmdate='" + mdate + "', trhdate='" + hdate + "',text='" + txt_desc.Text + "',remarks='" + txt_remark.Text + "',supno='" + txt_custno.Text + "',entries=" + (dataGridView1.RowCount - 1) + ",lastupdt=getdate(),amnttl=" + txt_total.Text + ",costttl=" + txt_cost.Text + ",usrid='" + txt_user.Text + "',whno='" + cmb_ftwh.SelectedValue + "',towhno='" + cmb_ftwh.SelectedValue + "' where branch='" + BL.CLS_Session.brno + "' and trtype='" + cmb_type.SelectedValue + "' and ref=" + txt_ref.Text + "", false);
    ...
    */
                  //  if (!row.IsNewRow && row.Cells[0].Value != null)
                    if ((!row.IsNewRow && row.Cells[0].Value != null) && (!row.IsNewRow && row.Cells[1].Value != null) && (!row.IsNewRow && row.Cells[3].Value != null))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO sto_dtl(branch,trtype,ref,trmdate, trhdate, itemno, qty, lprice, pack, pkqty,folio,whno,towhno,barcode,lcost,expdate,fprice) VALUES(@a1,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10,@a11,@a12,@a14,@a15,@a16,@a17,@exp,@fp)", con))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@fp", row.Cells[10].Value);
              ...
              //  if (BL.CLS_Session.is_dorymost.Equals("2") || (BL.CLS_Session.is_dorymost.Equals("1") && !string.IsNullOrEmpty(txt_key.Text) && txt_key.Visible==true))
               // save_acc1();
                save_acc2();
                isnew = false;
                isupdate = false;
               ...
               // inv_s = cmb_salctr.SelectedValue.ToString();
                //Thread a = new Thread(() => thread1(inv_t, inv_r));// new Thread(new ThreadStart(tc.thread1(cmb_type.SelectedValue.ToString(), txt_ref.Text.ToString(), cmb_salctr.SelectedValue.ToString())));
                //a.Start(); 
            ...
            if (btn_Post.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    try
                    {
                      ...
                      ///  daml.Insert_Update_Delete_Only("delete from acc_hdr where a_posted=0 and a_brno='" + BL.CLS_Session.brno + "' and sl_no='" + cmb_ftwh.SelectedValue + "' and a_type='" + cmb_type.SelectedValue + "' and a_ref=" + txt_ref.Text + "", false);
                        // exexcuted = exexcuted + daml.Insert_Update_Delete("delete from acc_dtl where a_ref=" + txt_ref.Text + " and a_type='" + comboBox1.SelectedValue + "'", false);
                        if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                           // daml.Insert_Update_Delete_Only("delete from acc_hdr where a_brno='" + BL.CLS_Session.brno + "' and sl_no='' and a_type='01' and a_ref=" + txt_jrdacc.Text + "", false);
                            daml.Insert_Update_Delete_Only("delete from acc_hdr where a_brno='" + BL.CLS_Session.brno + "' and a_type='" + cmb_type.SelectedValue + "' and a_ref=" + txt_ref.Text + "", false);
        ...
        private void Fill_Data(string slctr, string atype, string aref)
        {
            try
            {
                ...
                if (slctr.Equals("1"))
                {
                    dthdr = daml.SELECT_QUIRY_only_retrn_dt("select * from " + dbtoco + ".dbo.sto_hdr where trtype='" + atype + "' and ref=" + aref + " and branch='" + brtoco + "'");
                    dtdtl = daml.SELECT_QUIRY_only_retrn_dt("select aa.itemno itemno,bb.item_name item_name,aa.pack pack,aa.pkqty pkqty,aa.qty qty," + (pricnocost ? " aa.fprice" : " aa.lprice") + " lcost,(aa.qty*" + (pricnocost ? " aa.fprice" : " aa.lprice") + ") total," + (pricnocost ? " aa.fprice" : " aa.lcost") + " cost,aa.barcode barcode,iif(rtrim(ltrim(expdate))<>'', convert(varchar(10) ,cast([expdate] as date) ,110),'') expdate,aa.fprice pric,(aa.qty * aa.fprice) tpric  from " + dbtoco + ".dbo.sto_dtl aa,items bb where aa.itemno=bb.item_no and aa.trtype='" + atype + "' and aa.ref=" + aref + " and aa.branch='" + brtoco + "' order by aa.folio");// and aa.a_type='" + atype + "' and aa.a_ref=" + aref + "");      
                }
                else
                {
                    dthdr = daml.SELECT_QUIRY_only_retrn_dt("select * from sto_hdr where trtype='" + atype + "' and ref=" + aref + " and branch='" + BL.CLS_Session.brno + "'");
                    dtdtl = daml.SELECT_QUIRY_only_retrn_dt("select aa.itemno itemno,bb.item_name item_name,aa.pack pack,aa.pkqty pkqty,aa.qty qty,aa.lprice lcost,(aa.qty*aa.lprice) total,aa.lcost cost,aa.barcode barcode,iif(rtrim(ltrim(expdate))<>'', convert(varchar(10) ,cast([expdate] as date) ,110),'') expdate,aa.fprice pric,(aa.qty * aa.fprice) tpric  from sto_dtl aa,items bb where aa.itemno=bb.item_no and aa.trtype='" + atype + "' and aa.ref=" + aref + " and aa.branch='" + BL.CLS_Session.brno + "' order by aa.folio");// and aa.a_type='" + atype + "' and aa.a_ref=" + aref + "");
                }
                if (Convert.ToBoolean(dthdr.Rows[0]["isbrtrx"]) == true)
                {
                ...
                cmb_ftwh.SelectedValue = dthdr.Rows[0]["whno"];
              ...
              //  load_key();
               ...
               // DataTable dt = daml.CMD_SELECT_QUIRY_only_retrn_dt("select stkjvno from sto_hdr where trtype='" + a_type + "' and ref=" + aref + " and branch='" + BL.CLS_Session.brno + "'");
                int dtr = Convert.ToInt32(dthdr.Rows[0]["stkjvno"].ToString());
                if (dtr > 0)
                {
                    accdthdr = daml.SELECT_QUIRY_only_retrn_dt("select mainkey from acc_hdr where a_type='01' and a_ref = " + dtr + " and a_brno='" + BL.CLS_Session.brno + "'");
                    txt_key.Text = accdthdr.Rows[0]["mainkey"].ToString();
                   // MessageBox.Show(accdthdr.Rows[0]["mainkey"].ToString());
                    load_key();
                }
                else
                {
                    accdthdr = daml.SELECT_QUIRY_only_retrn_dt("select mainkey from acc_hdr where a_type='" + atype + "' and a_ref = " + aref + " and a_brno='" + BL.CLS_Session.brno + "'");
                    txt_key.Text = accdthdr.Rows[0]["mainkey"].ToString();
                   // MessageBox.Show(accdthdr.Rows[0]["mainkey"].ToString());
                    load_key();
                }
              ...
              //  accdthdr = daml.SELECT_QUIRY_only_retrn_dt("select * from acc_hdr where a_type='" + atype + "' and a_ref = " + aref + " and a_brno='" + BL.CLS_Session.brno + "'");
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              //  dt = dtdtl.Copy();
                ...
                if (File.Exists(Directory.GetCurrentDirectory() + @"\reports\Sto_inoutTran_rpt" + numericUpDown1.Value + ".rdlc"))
                    rf.reportViewer1.LocalReport.ReportPath = Directory.GetCurrentDirectory() + @"\reports\Sto_inoutTran_rpt" + numericUpDown1.Value + ".rdlc";
                else
                    rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Sto.rpt.Sto_inoutTran_rpt.rdlc";
               ...
               // parameters[7] = new ReportParameter("tax_id", BL.CLS_Session.tax_no);
                ...
                parameters[10] = new ReportParameter("nettotal", txt_totalprice.Text);

                BL.ToWord toWord = new BL.ToWord(Convert.ToDecimal(txt_totalprice.Text), currencies[Convert.ToInt32(BL.CLS_Session.cur)]);

                //  MessageBox.Show(toWord.ConvertToArabic());
                parameters[11] = new ReportParameter("a_toword", toWord.ConvertToArabic());
                parameters[12] = new ReportParameter("dpt_name", txt_name.Text);
                rf.reportViewer1.LocalReport.SetParameters(parameters);
        ...
        private void dataGridView1_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                if (dataGridView1.CurrentCell == dataGridView1[4, dataGridView1.CurrentRow.Index] || dataGridView1.CurrentCell == dataGridView1[5, dataGridView1.CurrentRow.Index] || dataGridView1.CurrentCell == dataGridView1[6, dataGridView1.CurrentRow.Index] || dataGridView1.CurrentCell == dataGridView1[10, dataGridView1.CurrentRow.Index] || dataGridView1.CurrentCell == dataGridView1[11, dataGridView1.CurrentRow.Index])
                {
                    //   total();
                    ...
                    dataGridView1.CurrentRow.Cells[11].Value = Convert.ToDouble(dataGridView1.CurrentRow.Cells[10].Value) * Convert.ToDouble(dataGridView1.CurrentRow.Cells[4].Value);
                }
                if (dataGridView1.CurrentCell == dataGridView1[2, dataGridView1.CurrentRow.Index] && isupdate)
                {
                    /*
        ...
        private void total()
        {
            double sum = 0, sumv = 0, sumc = 0,sump=0;
            foreach (DataGridViewRow ro in dataGridView1.Rows)
            {
                ...
                sump = sump + (Convert.ToDouble(ro.Cells[10].Value) * Convert.ToDouble(ro.Cells[4].Value));
            }
            //  textBox1.Text = sum.ToString();
            txt_total.Text = Math.Round(sum, 4).ToString();
            txt_cost.Text = Math.Round(sumc, 4).ToString();
            // txt_tax.Text = sumv.ToString();
            txt_totalprice.Text = Math.Round(sump, 2).ToString();
        ...
        //            if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
        //                daml.Insert_Update_Delete_retrn_int("INSERT INTO acc_hdr(a_brno,a_type,a_ref,a_mdate, a_hdate,a_text,a_amt,a_entries,usrid,jhsrc,sl_no,mainkey) VALUES('" + BL.CLS_Session.brno + "','21'," + jrdacc + ",'" + mdate + "','" + hdate + "'," + (BL.CLS_Session.is_dorymost.Equals("2") ? "'قيمة بضاعة جرد مستمر'" : "'قيمة بضاعة صادرة وواردة'") + "," + (Convert.ToDouble(txt_total.Text)) + "," + 2 + ",'" + txt_user.Text + "','Grd1','','"+txt_key.Text+"')", false);
        //            daml.SqlCon_Close(); 
        //        }
        //        else
        //        {
        ...
        //            //daml.SqlCon_Close();
        //            if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
        //                daml.Insert_Update_Delete_retrn_int("update acc_hdr set lastupdt=getdate(),a_mdate='" + mdate + "', a_hdate='" + hdate + "',a_amt=" + txt_cost.Text + ",usrid='" + txt_user.Text + "',mainkey='"+txt_key.Text+"' where a_ref=" + txt_jrdacc.Text + " and a_type='21' and a_brno='" + BL.CLS_Session.brno + "' and sl_no=''", false);
        ...
        //                    daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_camt, a_damt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','21'," + (isnew ? jrdacc : Convert.ToInt32(txt_jrdacc.Text)) + ",'" + (BL.CLS_Session.is_dorymost.Equals("2") ? stmkhzon : BL.CLS_Session.dtbranch.Rows[0]["stkoutacc"]) + "','" + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)).ToString() + " قيمة البضاعة صرف مخزني '," + Convert.ToDouble(txt_total.Text) + ",0,2,'" + mdate + "','" + hdate + "','C','','" + stcstcode + "')", false);
        //                }
        //                daml.SqlCon_Close();
        //                break;
        ...
        private void save_acc2()
        {
            ...
            try
            {
              ...
              //  DataTable dt = daml.SELECT_QUIRY_only_retrn_dt("select isnull(max(a_ref)," + BL.CLS_Session.dtbranch.Rows[0]["jv_01"] + ") from acc_hdr where a_type='01' and a_brno='" + BL.CLS_Session.brno + "'");
                DataTable dt = daml.SELECT_QUIRY_only_retrn_dt("select isnull(max(a_ref),0) from acc_hdr where a_type='" + cmb_type.SelectedValue + "' and a_brno='" + BL.CLS_Session.brno + "' and a_ref=" + ref_max + "");
 
                //int ref_max = Convert.ToInt32(dt.Rows[0][0]) + 1;
                string vvv = (cmb_type.SelectedValue.ToString().Equals("32") ? (" قيمة البضاعة صرف مخزني ") : (" قيمة البضاعة استلام مخزني ")) + " " + Convert.ToInt32(txt_ref.Text).ToString();
                if (isnew)
                {
                    daml.SqlCon_Open();
                    // int exexcuted = daml.Insert_Update_Delete_retrn_int("INSERT INTO acc_hdr(a_brno,a_type,a_ref,a_mdate, a_hdate,a_text,a_amt,a_entries,usrid,jhsrc,sl_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + ref_max + ",'" + mdate + "','" + hdate + "','" + txt_desc.Text + "'," + (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(0)) + "," + (dataGridView1.RowCount - 1) + ",'" + txt_user.Text + "','Sal','" + cmb_ftwh.SelectedValue + "')", false);
                    if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                        // MessageBox.Show("ok");
                      //  daml.Insert_Update_Delete_retrn_int("INSERT INTO acc_hdr(a_brno,a_type,a_ref,a_mdate, a_hdate,a_text,a_amt,a_entries,usrid,jhsrc,sl_no,mainkey) VALUES('" + BL.CLS_Session.brno + "','01'," + jrdacc + ",'" + mdate + "','" + hdate + "'," + (BL.CLS_Session.is_dorymost.Equals("2") ? "'" + vvv + " '" : "'" + vvv + "'") + "," + (Convert.ToDouble(txt_totalprice.Text)) + "," + 2 + ",'" + txt_user.Text + "','Grd2','','" + txt_key.Text + "')", false);
                        daml.Insert_Update_Delete_retrn_int("INSERT INTO acc_hdr(a_brno,a_type,a_ref,a_mdate, a_hdate,a_text,a_amt,a_entries,usrid,jhsrc,sl_no,mainkey) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + ref_max + ",'" + mdate + "','" + hdate + "'," + (BL.CLS_Session.is_dorymost.Equals("2") ? "'" + vvv + " '" : "'" + vvv + "'") + "," + (Convert.ToDouble(txt_totalprice.Text)) + "," + 2 + ",'" + txt_user.Text + "','Grd2','','" + txt_key.Text + "')", false);
                      //  MessageBox.Show("ok");
                    daml.SqlCon_Close();
                }
                else
                {
                   // DataTable dtifex = daml.SELECT_QUIRY_only_retrn_dt("select count(*) from acc_hdr where  1=1 and a_type='01' and a_brno='" + BL.CLS_Session.brno + "' and a_ref=" + txt_jrdacc.Text + "");
                    DataTable dtifex = daml.SELECT_QUIRY_only_retrn_dt("select count(*) from acc_hdr where  1=1 and a_type='" + cmb_type.SelectedValue + "' and a_brno='" + BL.CLS_Session.brno + "' and a_ref=" + txt_ref.Text + "");
                     ...
                     else
                     {
                         ...
                         //daml.SqlCon_Close();
                         if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                             daml.Insert_Update_Delete_retrn_int("update acc_hdr set lastupdt=getdate(),a_mdate='" + mdate + "', a_hdate='" + hdate + "',a_amt=" + (Convert.ToDouble(txt_totalprice.Text)) + ",usrid='" + txt_user.Text + "',mainkey='" + txt_key.Text + "',a_text='" + vvv + "' where a_ref=" + txt_ref.Text + " and a_type='" + cmb_type.SelectedValue + "' and a_brno='" + BL.CLS_Session.brno + "' and sl_no=''", false);
                         //   daml.Insert_Update_Delete_retrn_int("delete from acc_dtl where a_ref=" + txt_ref.Text + " and a_type='" + cmb_type.SelectedValue + "' and a_brno='" + BL.CLS_Session.brno + "' and sl_no='" + cmb_salctr.SelectedValue + "'", false);
                         if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                             daml.Insert_Update_Delete_retrn_int("delete from acc_dtl where a_ref=" + txt_ref.Text + " and a_type='" + cmb_type.SelectedValue + "' and a_brno='" + BL.CLS_Session.brno + "' and sl_no=''", false);
                         daml.SqlCon_Close();
                     }
                }
                ...
                switch (cmb_type.SelectedValue.ToString())
                {
                    ...
                    case "32":
                        ...
                        if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                        {
                            daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_camt, a_damt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + txt_key.Text + "','" + vvv + "'," + 0 + "," + (Convert.ToDouble(txt_totalprice.Text)) + ",1,'" + mdate + "','" + hdate + "','D','','" + stcstcode + "')", false);
                            if((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) !=0)
                                daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_camt, a_damt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + (BL.CLS_Session.is_dorymost.Equals("2") ? stmkhzon : inoutacc) + "','" + vvv + "'," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) < 0 ? 0 : (Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text))) + "," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) > 0 ? 0 : (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_totalprice.Text))) + ",2,'" + mdate + "','" + hdate + "'," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) > 0 ? "'C'" : "'D'") + ",'','" + stcstcode + "')", false);
                            daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_camt, a_damt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + (BL.CLS_Session.is_dorymost.Equals("2") ? stmkhzon : BL.CLS_Session.dtbranch.Rows[0]["stkoutacc"].ToString().Trim()) + "','" + vvv + "'," + (Convert.ToDouble(txt_total.Text)) + ",0,3,'" + mdate + "','" + hdate + "','C','','" + stcstcode + "')", false);
                        }
                        daml.SqlCon_Close();
                        break;
                    ...
                    case "31":
                        ...
                        if (BL.CLS_Session.is_dorymost.Equals("2") || BL.CLS_Session.is_dorymost.Equals("1"))
                        {
                            daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_damt, a_camt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + txt_key.Text + "','" + vvv + "'," + 0 + "," + (Convert.ToDouble(txt_totalprice.Text)) + ",1,'" + mdate + "','" + hdate + "','C','','" + stcstcode + "')", false);
                            if ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) != 0)
                                daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_damt, a_camt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + (BL.CLS_Session.is_dorymost.Equals("2") ? stmkhzon : inoutacc) + "','" + vvv + "'," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) < 0 ? 0 : (Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text))) + "," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) > 0 ? 0 : (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_totalprice.Text))) + ",2,'" + mdate + "','" + hdate + "'," + ((Convert.ToDouble(txt_totalprice.Text) - Convert.ToDouble(txt_total.Text)) > 0 ? "'D'" : "'C'") + ",'','" + stcstcode + "')", false);
                            daml.Insert_Update_Delete_Only("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_damt, a_camt, a_folio,a_mdate,a_hdate,jddbcr,sl_no,cc_no) VALUES('" + BL.CLS_Session.brno + "','" + cmb_type.SelectedValue + "'," + (isnew ? ref_max : Convert.ToInt32(txt_ref.Text)) + ",'" + (BL.CLS_Session.is_dorymost.Equals("2") ? stmkhzon : BL.CLS_Session.dtbranch.Rows[0]["stkinacc"].ToString().Trim()) + "','" + vvv + "'," + (Convert.ToDouble(txt_total.Text)) + ",0,3,'" + mdate + "','" + hdate + "','D','','" + stcstcode + "')", false);
                        }
        ...
        private void cmb_salctr_Leave(object sender, EventArgs e)
        {
            ...
            inoutacc = dr[0]["frq_sar_acc"].ToString();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Acc_Tran_All f6 = new Acc_Tran_All(cmb_type.SelectedValue.ToString(), txt_ref.Text, "");
                   // f6.MdiParent = this;
                    f6.ShowDialog();
            }
        }

        private void Sto_InOut_Shown(object sender, EventArgs e)
        {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                // dataGridView1.ReadOnly = false;
                var fsn = new Search_by_No_Copy("30");

                fsn.cmb_type.DataSource = dttrtyps;
                fsn.cmb_type.DisplayMember = "tr_name";
                fsn.cmb_type.ValueMember = "tr_no";
                /*
                fsn.cmb_salctr.DataSource = dtslctr;
                fsn.cmb_salctr.DisplayMember = "sl_name";
                fsn.cmb_salctr.ValueMember = "sl_no";
               ...
               // contoco = fsn.con4;
                dbtoco = fsn.dbco;
                brtoco = fsn.brco;
                pricnocost = fsn.checkBox1.Checked ? true : false;
                Fill_Data("1", fsn.cmb_type.SelectedValue.ToString(), fsn.textBox1.Text);
                //  total();
            }
            catch { }
        }
        ...
        private void designToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
            System.Diagnostics.Process.Start(Directory.GetCurrentDirectory() + @"\reports\Sto_inoutTran_rpt" + numericUpDown1.Value + ".rdlc");
            }
            catch { }
        }
    }
