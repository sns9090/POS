...
namespace POS.Sto
{
    public partial class Sto_ImpExp : BaseForm
    {
        ...
        public Sto_ImpExp(string slctr, string atype, string aref)
        {
            InitializeComponent();
                ...
                if (e.KeyCode == Keys.F8 && dataGridView1.ReadOnly==false)
                {
                    ...
                    try
                    {
                       ...
                       // string item_bar = chk_usebarcode.Checked==false ? "  rtrim(ltrim(item_no))=" : "  rtrim(ltrim(item_barcode))=";
                        string item_bar = 1 == 1 ? "  rtrim(ltrim(item_no))= " : "  rtrim(ltrim(item_barcode))= ";
        ...
        private void Add_btn_Click_1(object sender, EventArgs e)
        {
           ...
           // dataGridView1.Columns[3].ReadOnly = true;
            dataGridView1.Columns[3].ReadOnly = BL.CLS_Session.sysno.Equals("2") ? false : true;
    ...
    */
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // btn_Rfrsh_Click(sender, e);
                ...
                //if (dthdr.Rows[0][1].ToString().Equals("35") || cmb_type.SelectedValue.Equals("35"))
                //{
                //    MessageBox.Show(" هذه الحركة انشأت اّليا ولا يمكن تعديلها من هذه الشاشة ", "تحذير", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //    return;
        ...
        private void Sto_ImpExp_Shown(object sender, EventArgs e)
        {
