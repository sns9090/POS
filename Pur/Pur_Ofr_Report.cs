...
namespace POS.Pur
{
    public partial class Pur_Ofr_Report : BaseForm
    {
       ...
       // string typeno = "";
        ...
        private void SalesReport_Load(object sender, EventArgs e)
        {
         ...
         //   dttrtyps = daml.SELECT_QUIRY_only_retrn_dt("select * from trtypes where tr_no in(" + tr + ") and tr_no in('04','05','14','15')");
            cmb_type.DataSource = daml.SELECT_QUIRY_only_retrn_dt("select * from trtypes where tr_no in(" + tr + ") and tr_no in('26')");
