...
namespace POS.Pos
{
    public partial class SALES_D_TCH : Form
    {
        ...
        int confirmd = 1, it_ref_copy = 0, rs_ref = 0;
        string[] lines_prt = null;
        decimal price1 = 0, total1 = 0;
        BL.EncDec endc = new BL.EncDec();
        // SerialPort sp;
        public DataTable dts = null, hdTable, dtTable;
        ...
        bool connec_with_ser = true, prt = true, isocu = false;
        ...
        private void SALES_Load(object sender, EventArgs e)
        {
            ...
            // var min=new MAIN();
            if (BL.CLS_Session.scount == 0 || Application.OpenForms.OfType<SALES_D_TCH>().Count() == 1)
            ...
            try
            {
                ...
                if (e.KeyCode == Keys.F8 && e.Modifiers != Keys.Control && dataGridView1.CurrentRow.IsNewRow)
                {
                    ...
                    if (ds23.Tables["0"].Rows.Count > 0)
                    {
                        ...
                        if (Convert.ToDouble(ds23.Tables["0"].Rows[0]["cb"]) <= 0 && BL.CLS_Session.sal_nobal.Equals("0"))
                        {
                            player.Play();
                            MessageBox.Show(BL.CLS_Session.lang.Equals("E") ? "Not Allow More Current Balance" : "غير مسموح بتجاوز الرصيد", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        ...
                        row1.Cells[17].Value = ds23.Tables["0"].Rows[0]["cb"];
                        ...
                        //dataGridView1.CurrentRow.Cells[3].Value = dtNew.Rows[0][0];
                        ...
                        total();
                        if (BL.CLS_Session.use_cd && !BL.CLS_Session.port_no.Equals("99"))
                        ...
                        cssc.pictureBox2.Image = pictureBox1.Image;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows[0].Cells[3].Value != null)
            {
                ...
                if ((Convert.ToDouble(txt_recv.Text) + Convert.ToDouble(txt_cardpay.Text) >= Convert.ToDouble(lbl_mustpay.Text) && (string.IsNullOrEmpty(txt_custno.Text)) || chk_agel.Checked))
                {
                    ...
                    hdTable.Columns.AddRange(new DataColumn[26] { new DataColumn("brno", typeof(string)),new DataColumn("slno", typeof(string)),
                                                    new DataColumn("ref", typeof(int)),new DataColumn("contr", typeof(int)),
                                                    new DataColumn("type",typeof(int)),new DataColumn("date", typeof(DateTime)),
                                                    new DataColumn("total",typeof(float)) ,new DataColumn("count", typeof(float)),
                                                    new DataColumn("payed",typeof(float)) ,new DataColumn("total_cost", typeof(float)),
                                                    new DataColumn("saleman",typeof(string)) ,new DataColumn("req_no", typeof(int)),
                                                    new DataColumn("cust_no",typeof(int)) ,new DataColumn("discount", typeof(float)),
                                                    new DataColumn("net_total",typeof(float)) ,new DataColumn("sysdate", typeof(DateTime)),
                                                    new DataColumn("gen_ref",typeof(int)) ,new DataColumn("tax_amt", typeof(float)),
                                                    new DataColumn("dscper",typeof(float)) ,new DataColumn("card_type", typeof(int)),
                                                    new DataColumn("card_amt",typeof(float)) ,new DataColumn("rref", typeof(int)),
                                                    new DataColumn("rcontr",typeof(int)) ,new DataColumn("taxfree_amt", typeof(float)),
                                                    new DataColumn("note",typeof(string)) ,new DataColumn("mobile", typeof(string))});
                    ...
                    hdTable.Rows.Add(BL.CLS_Session.brno, BL.CLS_Session.slno, invref, BL.CLS_Session.ctrno, chk_delvry.Checked ? 5 : (!string.IsNullOrEmpty(txt_custno.Text) && chk_agel.Checked ? 3 : 1)
                        , DateTime.Now, (BL.CLS_Session.isshamltax.Equals("1") ? (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(txt_tax.Text)) : Convert.ToDouble(txt_total.Text))
                        , Convert.ToDouble(label3.Text), Convert.ToDouble(txt_recv.Text), Convert.ToDouble(textBox2.Text), txt_salid.Text, 0
                        , string.IsNullOrEmpty(txt_custno.Text) ? "0" : txt_custno.Text, Convert.ToDouble(txt_desc.Text)
                        , BL.CLS_Session.isshamltax.Equals("1") ? (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_desc.Text) + Convert.ToDouble(txt_tax.Text)) : (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_desc.Text))
                        , DateTime.Now, 0, string.IsNullOrEmpty(BL.CLS_Session.tax_no) ? 0 : Convert.ToDouble(txt_tax.Text)
                        , Convert.ToDouble(txt_dscper.Text), Convert.ToDouble(txt_cardpay.Text) > 0 ? cmb_cards.SelectedValue : 0
                        , Convert.ToDouble(txt_cardpay.Text), string.IsNullOrEmpty(s2) ? "0" : s2, string.IsNullOrEmpty(s1) ? "0" : s1, Convert.ToDouble(txt_taxfree.Text), txt_custnam.Text, txt_mobil.Text);

                    // MessageBox.Show("ok");
                    ////using (SqlCommand cmd1 = new SqlCommand("INSERT INTO pos_hdr (brno,slno,ref,contr,type,date,total,count,payed,total_cost,saleman,cust_no,discount,net_total,tax_amt,dscper,card_type,card_amt,note,taxfree_amt,mobile) VALUES(@br,@sl,@refhd,@ctr,@a0,@a1,@a2,@a3,@a4,@a5,@a8,@a9,@a10,@a11,@a12,@a13,@a14,@a15,@a16,@a17,@a18)", con2))
                    ////{
                    ...
                    ////    cmd1.Parameters.AddWithValue("@a0",chk_delvry.Checked? 5 : (!string.IsNullOrEmpty(txt_custno.Text) && chk_agel.Checked ? 3   : 1));
                    ...
                    dtTable = new DataTable();
                    dtTable.Columns.AddRange(new DataColumn[20] { new DataColumn("brno", typeof(string)),new DataColumn("slno", typeof(string)),
                                                    new DataColumn("ref", typeof(int)),new DataColumn("contr", typeof(int)),
                                                    new DataColumn("type",typeof(int)),new DataColumn("barcode", typeof(string)),
                                                    new DataColumn("name",typeof(string)) ,new DataColumn("unit", typeof(string)),
                                                    new DataColumn("price",typeof(float)) ,new DataColumn("qty", typeof(float)),
                                                    new DataColumn("cost",typeof(float)) ,new DataColumn("is_req", typeof(int)),
                                                    new DataColumn("itemno",typeof(string)) ,new DataColumn("srno", typeof(int)),
                                                    new DataColumn("pkqty",typeof(float)) ,new DataColumn("discpc", typeof(float)),
                                                    new DataColumn("tax_id",typeof(int)) ,new DataColumn("tax_amt", typeof(float)),
                                                    new DataColumn("rqty",typeof(float)) ,new DataColumn("offr_amt", typeof(float))});
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        if (!row.IsNewRow && row.Cells[0].Value != null && !row.Cells[0].Value.ToString().Trim().Equals("") && row.Cells[1].Value != null && !row.Cells[1].Value.ToString().Trim().Equals("") && row.Cells[2].Value != null && !row.Cells[2].Value.ToString().Trim().Equals("") && Convert.ToDouble(row.Cells[4].Value) != 0)
                        {
                            ...
                            dtTable.Rows.Add(BL.CLS_Session.brno, BL.CLS_Session.slno, reff, BL.CLS_Session.ctrno, chk_delvry.Checked ? 5 : (!string.IsNullOrEmpty(txt_custno.Text) && chk_agel.Checked ? 3 : 1)
                                       , row.Cells[0].Value, row.Cells[2].Value.ToString().Length > 100 ? row.Cells[2].Value.ToString().Substring(0, 100) : row.Cells[2].Value, row.Cells[3].Value, row.Cells[5].Value, row.Cells[4].Value, row.Cells[7].Value, 0
                                       , row.Cells[1].Value, srno, row.Cells[10].Value, row.Cells[6].Value, row.Cells[11].Value, string.IsNullOrEmpty(BL.CLS_Session.tax_no) ? 0 : Math.Round(Convert.ToDouble(row.Cells[12].Value), 4), 0, row.Cells[15].Value == null ? 0 : row.Cells[15].Value);
                            ...
                            ////    cmd.Parameters.AddWithValue("@r0", chk_delvry.Checked ? 5 : (!string.IsNullOrEmpty(txt_custno.Text) && chk_agel.Checked ? 3 : 1));
                    ...
                    using (SqlCommand cmd = new SqlCommand("Save_Pos_Hdr_Dtl"))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@sl_no", BL.CLS_Session.sl_no);
                        cmd.Parameters.AddWithValue("@contr", BL.CLS_Session.contr_id);
                        cmd.Parameters.AddWithValue("@ref", invref);
                        ...
                        cmd.Parameters.AddWithValue("@pos_dtl_tb", dtTable);
                        // cmd.Parameters.AddWithValue("@pu_dtl_tb", null);
                        // cmd.Parameters.AddWithValue("@sto_dtl_tb", null);

                        cmd.Parameters.AddWithValue("@pos_hdr_tb", hdTable);
                    ...
                    if (rs_ref > 0 && it_ref_copy > 0)
                    {
                        using (SqlCommand cmd = new SqlCommand("update r_pos_hdr set rref=@rref where contr=@contr and ref=@ref"))
                        {
                            ...
                            //cmd.Parameters.AddWithValue("@sl_no", BL.CLS_Session.sl_no);
                            cmd.Parameters.AddWithValue("@contr", BL.CLS_Session.contr_id);
                            cmd.Parameters.AddWithValue("@rref", rs_ref);
                            cmd.Parameters.AddWithValue("@ref", rs_ref);
                            // cmd.Parameters.AddWithValue("@trref", isnew ? ref_max : Convert.ToInt32(txt_ref.Text));
                            // MessageBox.Show("3", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            //cmd.Parameters.AddWithValue("@pos_dtl_tb", dtTable);
                            //// cmd.Parameters.AddWithValue("@pu_dtl_tb", null);
                    ...
                    if (BL.CLS_Session.autoposupdat)
                    {
                        Thread a = new Thread(() => thread2(reftosend, "s"));
                        a.Start();
                        // a.Abort();
                    }
        ...
        private void thread2(string inv, string typ)
        {
            try
            {
                string hdri, dtli;
                ...
                DataTable dthdr = daml.SELECT_QUIRY_only_retrn_dt("select * from " + hdri + " where ref=" + reftosend + "");
                DataTable dtdtl = daml.SELECT_QUIRY_only_retrn_dt("select * from " + dtli + " where ref=" + reftosend + "");
                ...
                for (int i = 0; i < dthdr.Rows.Count; i++)
                {
                    ...
                    string StrQuery = " MERGE " + hdri + " as t"
                ...
                {
                    string StrQuery = " MERGE " + dtli + " as t"
        ...
        private void dataGridView1_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            ...
            //try
            //{
            //   // double val = Convert.ToDouble(dataGridView1.CurrentRow.Cells[5]);
            ...
            try
            {
                ...
                if (e.KeyCode == Keys.Space || e.KeyCode == Keys.F6)
                {
                    ...
                    if (Convert.ToInt32(dtchkbar.Rows[0][0]) > 1)
                    {
                        ...
                        da23 = new SqlDataAdapter("select i.item_no , i.item_name,i.item_curcost,b.price as item_price,b.barcode as  item_barcode,b.pack,i.item_obalance,i.item_cbalance,i.item_group,i.item_image,i.item_req,t.tax_percent,b.pk_qty pkqty,i.item_tax i_tax,i.item_image img,b.min_price mp,i.item_cbalance cb from items i join items_bc b on b.item_no=i.item_no and b.barcode='" + firstColumnValue3 + "' join taxs t on i.item_tax=t.tax_id where i.inactive=0", con2);
                    ...
                    else
                    {
                        ...
                        da23 = new SqlDataAdapter("select i.item_no , i.item_name,i.item_curcost,b.price as item_price,b.barcode as  item_barcode,b.pack,i.item_obalance,i.item_cbalance,i.item_group,i.item_image,i.item_req,t.tax_percent,b.pk_qty pkqty,i.item_tax i_tax,i.item_image img,b.min_price mp,i.item_cbalance cb from items i join items_bc b on b.item_no=i.item_no and i.item_no='" + firstColumnValue3 + "' join taxs t on i.item_tax=t.tax_id where i.inactive=0", con2);
                    }
                    DataSet ds23 = new DataSet();
                    da23.Fill(ds23, "0");
                    ...
                    if (ds23.Tables["0"].Rows.Count == 1)
                    {
                        ...
                        DataView dv2 = dtunits.DefaultView;
                        dv2.RowFilter = "unit_id in('" + ds23.Tables["0"].Rows[0][5] + "')";
                        DataTable dtNew2 = dv2.ToTable();
                        ...
                        */
                        ...
                        dcombo.DataSource = dtNew2;
                        dcombo.DisplayMember = "unit_name";
                        dcombo.ValueMember = "unit_id";
                        //  MessageBox.Show(dtNew2.Rows[0][0].ToString());
                        //  dcombo.DisplayIndex = 0;

                        dataGridView1.Rows[rowindex].Cells[3] = dcombo;
                        dataGridView1.Rows[rowindex].Cells[3].Value = dtNew2.Rows[0][0];// ds23.Tables["0"].Rows[0][5];
                        ...
                        dataGridView1.Rows[rowindex].Cells[17].Value = ds23.Tables["0"].Rows[0]["cb"];
        ...
        private void textBox3_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                SqlDataAdapter da23 = new SqlDataAdapter("select i.item_no , i.item_name,i.item_curcost,i.item_price as item_price,i.item_barcode as  item_barcode,i.item_unit pack,i.item_obalance,i.item_cbalance,i.item_group,i.item_image,i.item_req,t.tax_percent,1 pkqty,i.item_tax i_tax,i.item_image img,b.min_price mp,i.item_cbalance cb from items i join taxs t on i.item_tax=t.tax_id  and i.item_no='" + textBox3.Text.Trim() + "' where i.inactive=0", con2);
                ...
                if (ds23.Tables["0"].Rows.Count > 0)
                {
                    ...
                    row.Cells[17].Value = ds23.Tables["0"].Rows[0]["cb"];
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    if (Convert.ToDouble(dataGridView1.CurrentRow.Cells[4].Value) == 0)
                        dataGridView1.CurrentRow.Cells[4].Value = Convert.ToDouble(1);

                    dataGridView1.CurrentRow.Cells[4].Value = Convert.ToDouble(dataGridView1.CurrentRow.Cells[4].Value);
                    dataGridView1.CurrentCell = dataGridView1.Rows[dataGridView1.NewRowIndex].Cells[0];
                }

                // if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[4] && Convert.ToDouble(dataGridView1.CurrentRow.Cells[4])==0)
                //if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[4] && Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[4].Value) == 0)
                //{
                ...
                //    ////dataGridView1.Select();
                //    ////total();
                //    MessageBox.Show("لا يسمح بقيمة صفر");
                //    dataGridView1.Rows[dataGridView1.NewRowIndex].Cells[4].Value = Convert.ToDouble(1);
                //}
                ...
                if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[0] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[1])
                {
                    ...
                    //   row.Cells[dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim().StartsWith(BL.CLS_Session.mizansart)? 16 : 0].Value.ToString().Trim().Equals(dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim().StartsWith(BL.CLS_Session.mizansart)? BL.CLS_Session.mizansart+"-" + dataGridView1.CurrentRow.Cells[0].Value.ToString().Substring(2, BL.CLS_Session.mizanitemlen) : dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim()));
                    //  row.Cells[dataGridView1.CurrentRow.Cells[0].Value.ToString().StartsWith(BL.CLS_Session.mizansart)? 16 : 0].Value.ToString().Trim().Equals(dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim()));
                    ...
                    if (matchedRow != null && BL.CLS_Session.imp_itm)
                    {
                        ...
                        //  double price = (double)matchedRow.Cells[3].Value;
                        matchedRow.Cells[4].Value = qty;
                        //  matchedRow.Cells[5].Value = !dataGridView1.CurrentRow.Cells[0].Value.ToString().StartsWith(BL.CLS_Session.mizansart) ? Convert.ToDouble(matchedRow.Cells[5].Value) : (Convert.ToDouble(matchedRow.Cells[5].Value) + (double)matchedRow.Cells[5].Value / Convert.ToDouble(qty));
                        matchedRow.Cells[8].Value = (Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) - ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) * Convert.ToDouble(matchedRow.Cells[6].Value) / 100);
                        matchedRow.Cells[12].Value = string.IsNullOrEmpty(BL.CLS_Session.tax_no) ? 0 : BL.CLS_Session.isshamltax.Equals("1") ? (Convert.ToDouble(matchedRow.Cells[9].Value)) / (Convert.ToDouble(100)) * ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) - ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) * Convert.ToDouble(matchedRow.Cells[6].Value)) / 100) : BL.CLS_Session.isshamltax.Equals("1") ? (Convert.ToDouble(matchedRow.Cells[9].Value)) / (Convert.ToDouble(100)) * ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) - ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) * Convert.ToDouble(matchedRow.Cells[6].Value)) / 100) : (Convert.ToDouble(matchedRow.Cells[9].Value)) / (Convert.ToDouble(100) + Convert.ToDouble(matchedRow.Cells[9].Value)) * ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) - ((Convert.ToDouble(matchedRow.Cells[5].Value) * Convert.ToDouble(matchedRow.Cells[4].Value)) * Convert.ToDouble(matchedRow.Cells[6].Value)) / 100);// Convert.ToDouble(dataGridView1.CurrentRow.Cells[7].Value)).ToString();
                    ...
                    if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[0] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[1])
                    {
                        ...
                        if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[0] && dataGridView1.Rows[rowindex].Cells[0].Value != null)
                        {
                            ...
                            if (ds2.Tables["0"].Rows.Count == 1)
                            {
                                ...
                                if (Convert.ToDouble(ds2.Tables["0"].Rows[0]["cb"]) <= 0 && BL.CLS_Session.sal_nobal.Equals("0"))
                                {
                                    player.Play();
                                    MessageBox.Show(BL.CLS_Session.lang.Equals("E") ? "Not Allow More Current Balance" : "غير مسموح بتجاوز الرصيد", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                    // dataGridView1.CurrentRow.Cells[5].Value = oval;
                                ...
                                */
                                ...
                                dataGridView1.Rows[rowindex].Cells[17].Value = ds2.Tables["0"].Rows[0]["cb"];
                                if (dataGridView1.Rows[rowindex].Cells[4].Value == null)
                                {
                                    dataGridView1.Rows[rowindex].Cells[4].Value = Convert.ToDouble("1");
                                }
                            ...
                            else
                            {
                                if (firstColumnValue.StartsWith(BL.CLS_Session.mizansart))
                                {
                                    ...
                                    ////var matchedRow = dataGridView1.Rows.OfType<DataGridViewRow>()
                                    ////                 .FirstOrDefault(row => row.Cells[0].Value != null && row.Cells[15].Value == null &&
                                    ////                  row.Cells[16].Value.ToString().Trim().Equals(firstColumnValue));
                                    //////  row.Cells[16].Value.ToString().Trim().Equals(firstColumnValue));
                                    ...
                                    if (ds3.Tables["0"].Rows.Count == 1)
                                    {
                                        ...
                                        dataGridView1.Rows[rowindex].Cells[17].Value = ds3.Tables["0"].Rows[0]["cb"];
                                        // dataGridView1.Rows[rowindex].Cells[15].Value = null;
                                        if (dataGridView1.Rows[rowindex].Cells[4].Value == null)
                                        {
                                            if (BL.CLS_Session.mizantype.ToString().Equals("0"))
                                                ...
                                                dataGridView1.Rows[rowindex].Cells[4].Value = Convert.ToDecimal(firstColumnValue.Substring(BL.CLS_Session.mizansart.Length + BL.CLS_Session.mizanitemlen, BL.CLS_Session.mizanpricelen - 3) + "." + firstColumnValue.Substring(BL.CLS_Session.mizansart.Length + BL.CLS_Session.mizanitemlen + BL.CLS_Session.mizanpricelen - 3, 3)) == 0 ? Convert.ToDecimal(1) : Convert.ToDecimal(firstColumnValue.Substring(BL.CLS_Session.mizansart.Length + BL.CLS_Session.mizanitemlen, BL.CLS_Session.mizanpricelen - 3) + "." + firstColumnValue.Substring(BL.CLS_Session.mizansart.Length + BL.CLS_Session.mizanitemlen + BL.CLS_Session.mizanpricelen - 3, 3));
                                        }
                                        if (dataGridView1.Rows[rowindex].Cells[5].Value == null)
                                        {
                                            if (BL.CLS_Session.mizantype.ToString().Equals("0"))
            ...
            if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[4] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[5] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[6])
            {
                ...
                //    // txt_desper.Text = "0";
                //}
                if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[5] && Convert.ToDouble(dataGridView1.CurrentRow.Cells[14].Value) != 0 && Convert.ToDouble(dataGridView1.CurrentRow.Cells[5].Value) < Convert.ToDouble(dataGridView1.CurrentRow.Cells[14].Value))
                {

                    MessageBox.Show(BL.CLS_Session.lang.Equals("E") ? "Not Allow Minimum Price" : "تجاوزت السعر الادنى للصنف", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //dataGridView1.CurrentRow.Cells[5].Value = oval;
                    dataGridView1.CurrentRow.Cells[5].Value = dataGridView1.CurrentRow.Cells[14].Value;
                    // txt_desper.Text = "0";
                    total();
                }

                //  MessageBox.Show(Convert.ToDouble(dataGridView1.CurrentRow.Cells[4].Value).ToString() + "----" + Convert.ToDouble(dataGridView1.CurrentRow.Cells[17].Value).ToString());
                if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[4] && Convert.ToDouble(dataGridView1.CurrentRow.Cells[4].Value) > Convert.ToDouble(dataGridView1.CurrentRow.Cells[17].Value) && BL.CLS_Session.sal_nobal.Equals("0"))
                {
                    player.Play();
                    MessageBox.Show(BL.CLS_Session.lang.Equals("E") ? "Not Allow More Current Balance" : "غير مسموح بتجاوز الرصيد", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    // dataGridView1.CurrentRow.Cells[5].Value = oval;
                ...
                cssc.txt_qty.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
                cssc.txt_total.Text = total1.ToString();
                cssc.pictureBox2.Image = pictureBox1.Image;
            }
        ...
        private void print_ref_fr()
        {
            try
            {
                ...
                BL.ToWord toWord = new BL.ToWord(Convert.ToDecimal(lbl_mustpay.Text), currencies[Convert.ToInt32(BL.CLS_Session.cur)]);
                ...
                if (BL.CLS_Session.is_einv_p2 && isocu == false)
                {
        ...
        private void dataGridView1_RowLeave(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (Convert.ToDouble(dataGridView1.CurrentRow.Cells[5].Value) < Convert.ToDouble(dataGridView1.CurrentRow.Cells[7].Value) && BL.CLS_Session.up_pricelowcost)
                {
                ...
                //if (!dataGridView1.CurrentRow.IsNewRow || dataGridView1.CurrentRow.Cells[0].Value == null || dataGridView1.CurrentRow.Cells[1].Value == null || dataGridView1.CurrentRow.Cells[2].Value == null)
                //{
                //    dataGridView1.Rows.RemoveAt(dataGridView1.CurrentRow.Index);
                //}
        ...
        private void dataGridView1_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                //if ((dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[0] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[1]) && (dataGridView1.CurrentCell.Value.ToString().Trim().Equals("")||dataGridView1.CurrentCell.Value==null) && !dataGridView1.CurrentRow.IsNewRow)
                //{
                ...
                //if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[0] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[1])
                //{
                //    if(dataGridView1.CurrentCell.Value==null || dataGridView1.CurrentCell.Value.ToString().Trim().Equals(""))
                //        dataGridView1.Rows.RemoveAt(dataGridView1.CurrentCell.RowIndex);
                //   // dataGridView1.Refresh();
                //}
                if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[5] && Convert.ToDouble(dataGridView1.CurrentRow.Cells[14].Value) != 0 && Convert.ToDouble(dataGridView1.CurrentRow.Cells[5].Value) < Convert.ToDouble(dataGridView1.CurrentRow.Cells[14].Value))
        ...
        {
            DataTable dt2 = daml.SELECT_QUIRY_only_retrn_dt("select cu_no ,cu_name ,cl_acc,cu_crlmt,cu_disc from customers a join cuclass b on a.cu_class=b.cl_no  where a.inactive=0 and a.cu_brno='" + BL.CLS_Session.brno + "' and cu_no='" + txt_custno.Text + "'");
        ...
        private void SALES_D_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (chk_delvry.Checked)
                    chk_delvry.Checked = false;
                else
                    chk_delvry.Checked = true;
            }
            ...
            if (e.KeyCode == Keys.F2 && dataGridView1.RowCount > 1)
            {
                if (!BL.CLS_Session.islight && !BL.CLS_Session.dtyrper.Rows[0]["mada_portno"].ToString().Equals("99"))
                {
                    ...
                    //             {
                    txt_recv.Text = "0";
                    txt_cardpay.Text = Convert.ToDouble(txt_cardpay.Text) > 0 ? txt_cardpay.Text : lbl_mustpay.Text;
                    txt_cardpay.Enabled = false;
                    Mada_Pay md = new Mada_Pay();
                    md.textBox1.Text = Math.Round(Convert.ToDouble(txt_cardpay.Text), 2).ToString();
                    md.ShowDialog();
            ...
            {
                DataTable dt = daml.SELECT_QUIRY_only_retrn_dt("select * from server");
                if (dt.Rows[0][0].ToString().Equals(""))
                {
                    MessageBox.Show("يرجى التاكد من اعدادات الاتصال بالسرفر", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void txt_cardpay_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            //if (e.KeyCode == Keys.F12 && dataGridView1.RowCount>1)
            //{
            //    txt_cardpay.Enabled = false;
            //    Mada_Pay md = new Mada_Pay();
            //    md.textBox1.Text =Math.Round(Convert.ToDouble(txt_cardpay.Text),2).ToString();
        ...
        {
            if (Convert.ToDouble(txt_recv.Text) == 0 && Convert.ToDouble(txt_cardpay.Text) == 0)
            ...
            if (e.KeyCode == Keys.Enter)
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(txt_code.Text))
                    {
                        ...
                        SqlDataAdapter da23 = new SqlDataAdapter("select i.item_no , i.item_name,i.item_curcost,b.price as item_price,b.barcode as  item_barcode,b.pack,i.item_obalance,i.item_cbalance,i.item_group,i.item_image,i.item_req,t.tax_percent,b.pk_qty pkqty,i.item_tax i_tax,i.item_image img,b.min_price mp,i.cbalance cb from items i join items_bc b on b.item_no=i.item_no " + condi + " join taxs t on i.item_tax=t.tax_id where i.inactive=0", con2);
        ...
        */
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            txt_recv.Text = Convert.ToDouble(txt_cardpay.Text) > 0 ? "0.00" : lbl_mustpay.Text;
            total();
            prt = false;
            if (Convert.ToDouble(lbl_mustpay.Text) <= 0)
            {
        ...
        private void btn_mins_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToBoolean(BL.CLS_Session.dtsalman.Rows[0]["sl_chgqty"]))
                {
                    if (dataGridView1.CurrentRow.IsNewRow)
                    {
                        dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value = Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value) > 1 ? Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value) - 1 : Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value);
                    ...
                    {
                        dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[4].Value = Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value) > 1 ? Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[4].Value) - 1 : Convert.ToDouble(dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[4].Value);
        ...
        private void btnDown(DataGridViewRow dtgvr)
        {
            ...
            try
            {
                 ...
                 */
                //if ((dtgvr.Index==0))
                //    dgv.Rows.Remove(dtgvr);
                //if ((dgv.SelectedCells.Count > 0))
                if ((dgv.CurrentRow.Index == dgv.NewRowIndex - 1))
                {
                    int curr_index = dgv.CurrentCell.RowIndex;
                    int curr_col_index = dgv.CurrentCell.ColumnIndex;
                    ...
                    dgv.Rows.Insert(dgv.Rows.Count - 1, dtgvr);
                    // this.dataGridView1.CurrentCell = this.dataGridView1[curr_col_index, curr_index + i];
                    dgv.Rows[dgv.NewRowIndex].Cells[curr_col_index].Selected = true;
                }
            }
            catch { }
        }
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    if (Convert.ToDouble(dgvr.Cells[4].Value) > Convert.ToDouble(dgvr.Cells[17].Value) && BL.CLS_Session.sal_nobal.Equals("0"))
                //    {
                //        MessageBox.Show(BL.CLS_Session.lang.Equals("E") ? "Not Allow More Current Balance" : "غير مسموح بتجاوز الرصيد", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //        // dataGridView1.CurrentRow.Cells[5].Value = oval;
                //        //dataGridView1.Rows.RemoveAt(dataGridView1.CurrentCell.RowIndex);
                //        //dataGridView1.CurrentCell = dataGridView1.Rows[dataGridView1.NewRowIndex].Cells[0];
                //        //return;
                //        dgvr.Cells[4].Value = Convert.ToDouble(1); 
                //    }
                //}
            }
            catch { }
        ...
        private void chk_qty_offer(DataGridViewRow dtgvr)
        {
            ...
            try
            {
                ...
                cssc.txt_iname.Text = dataGridView1.Rows[dtgvr.Index].Cells[2].Value.ToString();
                cssc.txt_iprice.Text = dataGridView1.Rows[dtgvr.Index].Cells[5].Value.ToString();
                cssc.txt_qty.Text = dataGridView1.Rows[dtgvr.Index].Cells[4].Value.ToString();
                cssc.txt_total.Text = total1.ToString();
                cssc.pictureBox2.Image = pictureBox1.Image;
                //int totalRows = dgv.Rows.Count;
                //// get index of the row for the selected cell
                ...
                // dataGridView1.CurrentCell = dataGridView1.Rows[dtgvr.Index].Cells[4];
        ...
        private void btn_resrv_Click(object sender, EventArgs e)
        {
            ...
            total();
            txt_recv.Text = lbl_mustpay.Text;
            DataTable dt2 = daml.SELECT_QUIRY_only_retrn_dt("select isnull(max(ref),0) as eee from r_pos_hdr where [contr]=" + BL.CLS_Session.ctrno + " and [brno]= '" + BL.CLS_Session.brno + "' ");
            txt_ref.Text = Convert.ToString(dt2.Rows[0][0]);
            //try
            //{
            // MessageBox.Show(Directory.GetCurrentDirectory() + "\\" + BL.CLS_Session.comp_logo);
            ...
            if (dataGridView1.Rows[0].Cells[3].Value != null)
            {
                if (string.IsNullOrEmpty(txt_custno.Text) && !chk_agel.Checked ? ((Convert.ToDouble(txt_recv.Text) + Convert.ToDouble(txt_cardpay.Text)) >= (BL.CLS_Session.isshamltax.Equals("2") ? (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_desc.Text)) : (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(txt_desc.Text) + Convert.ToDouble(txt_tax.Text)))) : 1 != 0)
                {
                    ...
                    // using (SqlCommand cmd1 = new SqlCommand("INSERT INTO DB.dbo.sales_hdr (date, total, count) VALUES(@a1,@a2,@a3)", con2))
                    using (SqlCommand cmd1 = new SqlCommand("INSERT INTO r_pos_hdr (brno,slno,ref,contr,type,date,total,count,payed,total_cost,saleman,cust_no,discount,net_total,tax_amt,dscper,card_type,card_amt,note,taxfree_amt,mobile) VALUES(@br,@sl,@refhd,@ctr,@a0,@a1,@a2,@a3,@a4,@a5,@a8,@a9,@a10,@a11,@a12,@a13,@a14,@a15,@a16,@a17,@a18)", con2))
                    {
                        cmd1.Parameters.AddWithValue("@br", BL.CLS_Session.brno);
                        cmd1.Parameters.AddWithValue("@sl", BL.CLS_Session.slno);
                        cmd1.Parameters.AddWithValue("@refhd", invref);
                        ...
                        cmd1.Parameters.AddWithValue("@a2", (BL.CLS_Session.isshamltax.Equals("1") ? (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(txt_tax.Text)) : Convert.ToDouble(txt_total.Text)));
                        cmd1.Parameters.AddWithValue("@a3", Convert.ToDouble(label3.Text));
                        cmd1.Parameters.AddWithValue("@a4", Convert.ToDouble(0));
                        cmd1.Parameters.AddWithValue("@a5", Convert.ToDouble(textBox2.Text));
                        //  cmd1.Parameters.AddWithValue("@a6", Convert.ToInt32(lblcashir.Text));
                        //  cmd1.Parameters.AddWithValue("@a7", comp_id);
                        cmd1.Parameters.AddWithValue("@a8", txt_salid.Text);
                    ...
                    foreach (DataGridViewRow row in dataGridView1.Rows)
                    {
                        ...
                        if (!row.IsNewRow && row.Cells[0].Value != null && !row.Cells[0].Value.ToString().Trim().Equals("") && row.Cells[1].Value != null && !row.Cells[1].Value.ToString().Trim().Equals("") && row.Cells[2].Value != null && !row.Cells[2].Value.ToString().Trim().Equals(""))
                        {
                            // using (SqlCommand cmd = new SqlCommand("INSERT INTO DB.dbo.sales_dtl (ref, barcod, name, unit, price) VALUES(@r1,@c1,@c2,@c3,@c4)", con2))
                            using (SqlCommand cmd = new SqlCommand("INSERT INTO r_pos_dtl (brno,slno,contr,ref,type, barcode, name, unit, price, qty, cost,is_req,itemno,srno,pkqty,discpc,tax_id,tax_amt,offr_amt) VALUES(@br,@sl,@ctr,@r1,@r0,@c1,@c2,@c3,@c4,@c5,@c6,@c9,@c10,@sn,@pk,@c11,@c12,@c13,@c14)", con2))
                            {
                                cmd.Parameters.AddWithValue("@br", BL.CLS_Session.brno);
                                cmd.Parameters.AddWithValue("@sl", BL.CLS_Session.slno);
                                //cmd.Parameters.AddWithValue("@refdt", invref);
                                ...
                                cmd.Parameters.AddWithValue("@r1", reff);
                                cmd.Parameters.AddWithValue("@r0", 4);
                                cmd.Parameters.AddWithValue("@c1", row.Cells[0].Value);
                                cmd.Parameters.AddWithValue("@c2", row.Cells[2].Value.ToString().Length > 100 ? row.Cells[2].Value.ToString().Substring(0, 100) : row.Cells[2].Value);
                                cmd.Parameters.AddWithValue("@c3", row.Cells[3].Value);
                                cmd.Parameters.AddWithValue("@c4", row.Cells[5].Value);
                                ...
                                cmd.Parameters.AddWithValue("@c11", row.Cells[6].Value);
                                cmd.Parameters.AddWithValue("@c12", row.Cells[11].Value);
                                cmd.Parameters.AddWithValue("@c13", string.IsNullOrEmpty(BL.CLS_Session.tax_no) ? 0 : Math.Round(Convert.ToDouble(row.Cells[12].Value), 2));
                                cmd.Parameters.AddWithValue("@c14", row.Cells[15].Value == null ? 0 : row.Cells[15].Value);
                    ...
                    //if (BL.CLS_Session.autoposupdat)
                    //{
                    //    a = new Thread(() => thread2(reftosend,"r"));
                    //    a.Start();
                    //    // a.Abort();
                    //}
                    btn_resrv.Enabled = true;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Call_Inv ci = new Call_Inv();
                ci.ShowDialog();

                if (string.IsNullOrEmpty(ci.textBox1.Text))
                {
                    MessageBox.Show("لا يوجد فاتورة", "تنبيه", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                else
                {
                    ...
                    {
                        s1 = ci.textBox1.Text.Substring(0, ci.textBox1.Text.IndexOf("-"));
                        s2 = ci.textBox1.Text.Substring(ci.textBox1.Text.IndexOf("-") + 1);
                    }
                    else
                    {
                        s1 = BL.CLS_Session.contr_id;
                    ...
                    SqlDataAdapter da22 = new SqlDataAdapter("select ref from  r_pos_hdr where contr=" + s1 + " and ref=" + s2 + "", con2);
                    SqlDataAdapter da23 = new SqlDataAdapter("select b.itemno , b.name,i.item_curcost,b.price as item_price,b.barcode as  item_barcode,b.unit pack,i.item_obalance,i.item_cbalance,i.item_group,i.item_image,i.item_req,t.tax_percent,1 pkqty,i.item_tax i_tax,i.item_image img,i.min_price mp,b.qty,b.discpc,i.item_cbalance cb from r_pos_dtl b join items i on b.itemno=i.item_no join taxs t on i.item_tax=t.tax_id  where b.contr=" + s1 + " and b.ref=" + s2 + "", con2);

                    DataSet ds23 = new DataSet();
                    da23.Fill(ds23, "0");
                    da22.Fill(ds23, "1");
                    if (ds23.Tables["1"].Rows.Count > 0)
                    {
                        rs_ref = Convert.ToInt32(ds23.Tables["1"].Rows[0][0].ToString());
                        it_ref_copy = 1;
                    }
                    else
                    {
                    ...
                    if (ds23.Tables["0"].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < ds23.Tables["0"].Rows.Count; i++)
                        {
                            ...
                            row.Cells[17].Value = ds23.Tables["0"].Rows[i]["cb"];
                        ...
                        /* foreach (DataGridViewRow r in dataGridView1.Rows)
                         {
                             ...
                             DataView dv1 = dtunits.DefaultView;
                             //  dv1.RowFilter = "unit_id in('" + dt222.Rows[0][5] + "','" + dt222.Rows[0][12] + "','" + dt222.Rows[0][15] + "','" + dt222.Rows[0][18] + "')";
                             dv1.RowFilter = "unit_id in('" + r.Cells[3].Value.ToString() + "')";
                             DataTable dtNew = dv1.ToTable();
                             dcombo.DataSource = dtNew;
                             dcombo.DisplayMember = "unit_name";
                             dcombo.ValueMember = "unit_id";
        ...
        private void SALES_D_TCH_Activated(object sender, EventArgs e)
        {
            //cssc.Visible = true; 
            // cssc.
        }
