...
namespace POS.Pos
{
    public partial class Apps : BaseForm
    {
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
           ...
           // this.dataGridView1.Columns[0].Frozen = true;
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select * from pos_cards", sqlConnection);
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                if (dtgv.Index < 4)
                { dtgv.Cells[0].ReadOnly = true; dtgv.Cells[1].ReadOnly = true; dtgv.Cells[2].ReadOnly = true; }
                else
                { dtgv.Cells[0].ReadOnly = false; dtgv.Cells[1].ReadOnly = false; dtgv.Cells[2].ReadOnly = false; }
            }
