       ...
       // string typeno = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlDataAdapter da3 = new SqlDataAdapter("select [ref],[contr],[type],[date],[total],[count],[payed],[total_cost],[saleman] from pos_hdr where date between'" + xxx + "' and '" + zzz + "' and cust_no = " + Convert.ToInt32(textBox1.Text) + "", con3);
                ...
                SqlDataAdapter da4 = new SqlDataAdapter("select sum(total),sum(total_cost),sum(payed) from pos_hdr where date between'" + xxx + "' and '" + zzz + "' and cust_no = " + Convert.ToInt32(textBox1.Text) + "", con3);
                ...
                label7.Text = ds3.Tables[1].Rows[0][2].ToString();

                label9.Text = Convert.ToString(Convert.ToDouble(label1.Text) - Convert.ToDouble(label7.Text));
        ...
        private void DilySalesReport_Load(object sender, EventArgs e)
        {
            ...
            maskedTextBox1.Text = DateTime.Now.ToString("yyyy-01-01") + "05:00:00";
            maskedTextBox2.Text = DateTime.Now.ToString("yyyy-12-31") + "05:00:00";
            //string xxx;
            //xxx = maskedTextBox1.Text.ToString();
            //DateTime zzz = Convert.ToDateTime(xxx).AddHours(24);
