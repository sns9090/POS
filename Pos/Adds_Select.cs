...
namespace POS.Pos
{
    public partial class Adds_Select : BaseForm
    {
        public string val = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dgr in dataGridView1.Rows)
            {
                ...
                ch1 = (DataGridViewCheckBoxCell)dataGridView1.Rows[dgr.Index].Cells[2];

                if (ch1.Value == null)
                    ch1.Value = false;

                if(Convert.ToBoolean(ch1.Value) == true)
                     val = val + " - " + dgr.Cells[1].Value;
            }
            this.Close();
            //try
            //{
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
           ...
           // this.dataGridView1.Columns[0].Frozen = true;
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select [add_no],[add_desc],0 se from Pos_Adds", sqlConnection);
