...
namespace POS.Pos
{
    public partial class Pos_Drivers : BaseForm
    {
       // SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
          ...
          //  sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select sp_brno,sp_id,sp_name,sp_short,sp_percent,sp_target,cashcrdit from pos_drivers where sp_brno='" + BL.CLS_Session.brno + "' and sp_name like '%" + textBox1.Text + "%' order by sp_id", sqlConnection);
