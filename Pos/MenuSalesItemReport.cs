...
namespace POS.Pos
{
    public partial class MenuSalesItemReport : BaseForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter darown = new SqlDataAdapter("select item_name a_name,round(item_obalance,2) a_opnbal,item_no a_key  from items where item_no='" + txt_code.Text + "'", con3);
                // darown.Fill(dth);
