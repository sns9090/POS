...
namespace POS.Pos
{
    public partial class Pos_Report_items : BaseForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DateTime tempDate = Convert.ToDateTime(datval.convert_to_yyyy_MMddwith_dash(txt_tdate.Text) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000", culture).AddHours(24);
            // string.
            ...
            try
            {
                ...
                if (typeno == "")
                {
                    ...
                    SqlDataAdapter da3 = new SqlDataAdapter("select [ref] ,[contr] ,[type],[date] ,[total] ,[count] ,[payed],[total_cost],[saleman] ,[req_no] ,[cust_no],[discount],[net_total] from pos_hdr where date between'" + xxx + "' and '" + zzz + "'", con3);
                ...
                {// and type = " + typeno + "
                    ...
                    string zzz;
                    zzz = maskedTextBox2.Text.ToString();
                    SqlDataAdapter da3 = new SqlDataAdapter("select [ref] ,[contr] ,[type],[date] ,[total] ,[count] ,[payed],[total_cost],[saleman] ,[req_no] ,[cust_no],[discount],[net_total] from pos_hdr where date between'" + xxx + "' and '" + zzz + "' and type = " + typeno + "", con3);
              ...
              //  string usrname = cmb_user.SelectedIndex != -1 ? " and usrid = '" + cmb_user.SelectedValue.ToString() + "' " : " ";
                string cond, congrp, congrsp, condfcst, conditem, conslctr;
                if (chk_combitm.Checked)
                {
                    cond = checkBox1.Checked ? "h.date" : "h.date";
                    //  string condplc = chk_plc.Checked ? " and (items.item_curcost * pos_dtl.pkqty) > pos_dtl.price" : " ";
                    // string condp = rad_posted.Checked ? " and pos_hdr.posted=1 " : (rad_notpostd.Checked ? " and pos_hdr.posted=0 " : " ");

                    congrp = cmb_grp.SelectedIndex != -1 ? " and b.item_group='" + cmb_grp.SelectedValue + "' " : " ";
                    congrsp = cmb_sgrp.SelectedIndex != -1 ? " and b.sgroup='" + cmb_sgrp.SelectedValue + "' " : " ";

                    //  string condf = txt_fno.Text != "" ? txt_fno.Text : "1";
                    // string condt = txt_tno.Text != "" ? txt_tno.Text : "999999999";
                    // string condft = " and pos_hdr.ref between " + condf + " and " + condt + " ";
                    condfcst = txt_code.Text != "" ? " and h.custno='" + txt_code.Text + "' " : " ";
                    conditem = txt_itemno.Text != "" ? " and b.item_no='" + txt_itemno.Text + "' " : " and b.item_no like '%" + txt_itemno.Text + "%' ";
                    // string conddate = " and c.invmdate '" + txt_code.Text + "' " : " ";

                    conslctr = cmb_salctr.SelectedIndex != -1 ? " and h.slno = '" + cmb_salctr.SelectedValue.ToString() + "' " : " and h.brno + h.slno in(" + sl + ") ";
               
                }
                else
                {
                    cond = checkBox1.Checked ? "pos_hdr.date" : "pos_hdr.date";
                    //  string condplc = chk_plc.Checked ? " and (items.item_curcost * pos_dtl.pkqty) > pos_dtl.price" : " ";
                    // string condp = rad_posted.Checked ? " and pos_hdr.posted=1 " : (rad_notpostd.Checked ? " and pos_hdr.posted=0 " : " ");

                    congrp = cmb_grp.SelectedIndex != -1 ? " and items.item_group='" + cmb_grp.SelectedValue + "' " : " ";
                    congrsp = cmb_sgrp.SelectedIndex != -1 ? " and items.sgroup='" + cmb_sgrp.SelectedValue + "' " : " ";

                    //  string condf = txt_fno.Text != "" ? txt_fno.Text : "1";
                    // string condt = txt_tno.Text != "" ? txt_tno.Text : "999999999";
                    // string condft = " and pos_hdr.ref between " + condf + " and " + condt + " ";
                    condfcst = txt_code.Text != "" ? " and pos_hdr.custno='" + txt_code.Text + "' " : " ";
                    conditem = txt_itemno.Text != "" ? " and items.item_no='" + txt_itemno.Text + "' " : " and items.item_no like '%" + txt_itemno.Text + "%' ";
                    // string conddate = " and c.invmdate '" + txt_code.Text + "' " : " ";

                    conslctr = cmb_salctr.SelectedIndex != -1 ? " and pos_hdr.slno = '" + cmb_salctr.SelectedValue.ToString() + "' " : " and pos_hdr.brno + pos_hdr.slno in(" + sl + ") ";
                }
                //  string qstr = "select slno sl_no,type a_type,ref a_ref,CONVERT(VARCHAR(10), CAST(invmdate as date), 105) a_mdate,CONVERT(VARCHAR(10), CAST(invhdate as date), 105) a_hdate,text a_text,invttl invttl,invdsvl invdsvl,tax_amt_rcvd tax,nettotal nettotal,posted a_p,type a_t,round(((invttl - invdsvl) - invcst),2) invwin,('%' + CAST(round((((invttl - invdsvl) - invcst)/(invttl - invdsvl))*100,2) as varchar)) invwinp  from pos_hdr where brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + conslctr + " and " + cond + " between '" + txt_fdate.Text.Replace("-", "") + "' and '" + txt_tdate.Text.Replace("-", "") + "'";
              /*  string qstr = "select a.item_no item_no,a.item_name item_name,( select sum(b.qty) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and b.type in ('04','05') where a.item_no=b.itemno) sal_qty"
                            ...
                            +"  from items a ";
                */
                //////string qstr = "select a.item_no item_no,a.item_name item_name,(select isnull(sum(b.qty * b.pkqty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) sal_qty"
                //////           + " ,(select isnull(sum(b.qty * b.pkqty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) rsal_qty"
                //////           + " ,0 net_sal_qty"
                //////           + " ,round(((select isnull(sum(b.qty * b.pkqty * b.price),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * b.price),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2) net_qty_price"
                //////           + " , round(((select isnull(sum(b.qty * b.pkqty * (b.price-b.cost)),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * (b.price-b.cost)),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2) item_win,'0' item_winp, a.item_price price, a.item_curcost cost from items a  " + conditem + congrp + congrsp + ""
                //////           + " and round(((select isnull(sum(b.qty * b.pkqty * b.price),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * b.price),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2)<>0";
                //////         //  +" where cast((select isnull(sum(b.qty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('04','05') where a.item_no=b.itemno) as float) <> 0"

                //string qstr = "select a.item_no item_no,a.item_name item_name,(select isnull(sum(b.qty * b.pkqty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) sal_qty"
                //          + " ,(select isnull(sum(b.qty * b.pkqty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) rsal_qty"
                //          + " ,0 net_sal_qty"
                //          + " ,round(((select isnull(sum(b.qty * b.pkqty * (case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * (case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2) net_qty_price"
                //          + " , round(((select isnull(sum(b.qty * b.pkqty * ((case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )-b.cost)),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * ((case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )-b.cost)),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2) item_win,'0' item_winp, a.item_price price, a.item_curcost cost from items a  " + conditem + congrp + congrsp + ""
                //          + " and round(((select isnull(sum(b.qty * b.pkqty * (case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('04','05') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno) - (select isnull(sum(b.qty * b.pkqty * (case when c.with_tax=1 then (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) - (((b.price-(b.tax_amt/(b.qty * b.pkqty))-(b.offr_amt/(b.qty * b.pkqty)))) * c.invdspc/100)) else ((b.price) - ((b.price) * c.invdspc/100)) end )),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and c.slno=b.slno and b.type in ('14','15') " + condft + condp + condfcst + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' where a.item_no=b.itemno)),2)<>0";

                //////////string qstr = "Select isnull(pos_dtl.itemno,' ') as item_no,rtrim(rTrim(items.item_Name)) as item_name, sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(1,3,4,5,6) then 1 else 0 end)) as sal_qty"
                //////////            + " , sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(0,2) then 1 else 0 end)) as rsal_qty"
                //////////            + " ,0 net_sal_qty"
                //////////            + " , (sum(((qty*pkqty*(price-iif(1=1,(price*dscper/100),floor(price*dscper/100))))-offr_amt)*IIF(pos_hdr.type in(1,3,4,5,6),1,0))-sum(((qty*pkqty*(price-iif(1=1,(price*dscper/100),floor(price*dscper/100))))-offr_amt)*IIF(pos_hdr.type in(0,2),1,0))) as net_qty_price"
                //////////            + " , sum(((qty*pkqty*(price-iif(1=1,(price*dscper/100),floor(price*dscper/100)))-item_curcost)-offr_amt)*IIF(pos_hdr.type in(1,3,4,5,6),1,0)) as item_win,'0' item_winp, 0 price, 0 cost"
                //////////            + " from pos_hdr inner Join pos_dtl LEFT OUTER JOIN items  ON pos_dtl.itemno=items.item_no on pos_hdr.brno=pos_dtl.brno and pos_hdr.contr=pos_dtl.contr and pos_hdr.ref=pos_dtl.ref and pos_hdr.slno=pos_dtl.slno where pos_hdr.brno='" + BL.CLS_Session.brno + "' and " + cond + "  between '" + datval.convert_to_yyyyDDdd(xxx) + " 05:00:00.000' and '" + datval.convert_to_yyyyDDdd(zzz) + " 05:00:00.000' " + condfcst + conditem + congrp + congrsp + conslctr + "  GROUP BY pos_dtl.itemno,rtrim(rTrim(items.item_Name)) order By 1";
                string qstr;
                if (chk_combitm.Checked)
                {
                    qstr = "select a.itemno_cmbin item_no,b.item_name,isnull(sum(c.qty*a.nqty*(case when c.type in(1,3,4,5,6) then 1 else 0 end)),0) as sal_qty,isnull(sum(c.qty*a.nqty*(case when c.type in(0,2) then 1 else 0 end)),0) as rsal_qty,0.00 net_sal_qty,0.00 net_qty_price, 0 item_win,'0' item_winp, 0 price, 0 cost from items_cmbin a  join items b on a.itemno_cmbin=b.item_no left join pos_dtl c on a.itemno=c.itemno "
                         + " left join pos_hdr h on h.brno=c.brno and h.contr=c.contr and h.ref=c.ref and h.slno=c.slno "
                         + " where h.brno='" + BL.CLS_Session.brno + "' and " + cond + "  between '" + datval.convert_to_yyyyDDdd(xxx) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' and '" + datval.convert_to_yyyyDDdd(zzz) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' " + condfcst + conditem + congrp + congrsp + conslctr //+ "   GROUP BY pos_dtl.itemno,rtrim(rTrim(items.item_Name)) ";
                         + " group by a.itemno_cmbin,b.item_name having isnull(sum(c.qty*a.nqty),0)<>0";
                }
                else
                {
                    if (chk_ibc.Checked)
                    {
                        //qstr = " Select isnull(pos_dtl.barcode,' ') as item_no,rtrim(rTrim(items.item_Name)) as item_name, sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(1,3,4,5,6) then 1 else 0 end)) as sal_qty"
                        //            + "  , sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(0,2) then 1 else 0 end)) as rsal_qty"
                        //            + "  ,0 net_sal_qty"
                        //            + "  , sum(((qty*(price-price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(1,3,4,5,6),1,0))- sum(((qty*(price-price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(0,2),1,0)) as net_qty_price"
                        //            + "  , 0 item_win,'0' item_winp, 0 price, 0 cost"
                        //            + "  from pos_hdr inner Join pos_dtl LEFT OUTER JOIN items  ON pos_dtl.itemno=items.item_no on pos_hdr.brno=pos_dtl.brno and pos_hdr.contr=pos_dtl.contr and pos_hdr.ref=pos_dtl.ref and pos_hdr.slno=pos_dtl.slno where pos_hdr.brno='" + BL.CLS_Session.brno + "' and " + cond + "  between '" + datval.convert_to_yyyyDDdd(xxx) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' and '" + datval.convert_to_yyyyDDdd(zzz) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' " + condfcst + conditem + congrp + congrsp + conslctr + "   GROUP BY pos_dtl.barcode,rtrim(rTrim(items.item_Name)) ";
                    qstr = "UPDATE t1 SET  t1.unit = t2.pack FROM   pos_dtl t1    INNER JOIN items_bc t2   ON t1.barcode = t2.barcode WHERE  t2.pack<> 1;"
                        + @" Select isnull(pos_dtl.itemno,' ') as item_no,rtrim(rTrim(items.item_name + ' ' +units.unit_name)) as item_name, sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(1,3,4,5,6) then 1 else 0 end)) as sal_qty
                                 , sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(0,2) then 1 else 0 end)) as rsal_qty
                                 ,0 net_sal_qty
                                 , round(sum(((qty*(pos_dtl.price-pos_dtl.price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(1,3,4,5,6),1,0))- sum(((qty*(pos_dtl.price-pos_dtl.price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(0,2),1,0)),2) as net_qty_price
                                 , 0 item_win,'0' item_winp, 0 price, 0 cost
                                    from pos_hdr inner Join pos_dtl LEFT OUTER JOIN items_bc  ON pos_dtl.barcode=items_bc.barcode on pos_hdr.brno=pos_dtl.brno and pos_hdr.contr=pos_dtl.contr and pos_hdr.ref=pos_dtl.ref and pos_hdr.slno=pos_dtl.slno LEFT OUTER JOIN units on pos_dtl.unit=units.unit_id LEFT OUTER JOIN items  ON items.item_no=pos_dtl.itemno "
                                + " where pos_hdr.brno='" + BL.CLS_Session.brno + "' and " + cond + "  between '" + datval.convert_to_yyyyDDdd(xxx) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' and '" + datval.convert_to_yyyyDDdd(zzz) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' " + condfcst + conditem + congrp + congrsp + conslctr
                                + " GROUP BY isnull(pos_dtl.itemno,' ') ,rtrim(rTrim(items.item_name + ' ' +units.unit_name)) ;";
                    }
                    else
                    {
                        qstr = " Select isnull(pos_dtl.itemno,' ') as item_no,rtrim(rTrim(items.item_Name)) as item_name, sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(1,3,4,5,6) then 1 else 0 end)) as sal_qty"
                                    + "  , sum(pos_dtl.qty*pos_dtl.pkqty*(case when pos_hdr.type in(0,2) then 1 else 0 end)) as rsal_qty"
                                    + "  ,0 net_sal_qty"
                                    + "  , round(sum(((qty*(price-price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(1,3,4,5,6),1,0))- sum(((qty*(price-price*dscper/100))-offr_amt)*IIF(pos_hdr.type in(0,2),1,0)),2) as net_qty_price"
                                    + "  , 0 item_win,'0' item_winp, 0 price, 0 cost"
                                    + "  from pos_hdr inner Join pos_dtl LEFT OUTER JOIN items  ON pos_dtl.itemno=items.item_no on pos_hdr.brno=pos_dtl.brno and pos_hdr.contr=pos_dtl.contr and pos_hdr.ref=pos_dtl.ref and pos_hdr.slno=pos_dtl.slno where pos_hdr.brno='" + BL.CLS_Session.brno + "' and " + cond + "  between '" + datval.convert_to_yyyyDDdd(xxx) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' and '" + datval.convert_to_yyyyDDdd(zzz) + " " + (BL.CLS_Session.posatrtday.ToString().Length == 1 ? "0" + BL.CLS_Session.posatrtday.ToString() : BL.CLS_Session.posatrtday.ToString()) + ":00:00.000' " + condfcst + conditem + congrp + congrsp + conslctr + "   GROUP BY pos_dtl.itemno,rtrim(rTrim(items.item_Name)) ";
                    }
                }
                        ...
                        //   + " and cast((select isnull(sum(b.qty),0) from pos_dtl b join pos_hdr c on c.brno=b.brno and c.ref=b.ref and c.type=b.type and b.type in ('14','15') where a.item_no=b.itemno) as float) <> 0";
                /*
                ...
                */
              //  dt = daml.SELECT_QUIRY_only_retrn_dt(qstr + " and type like '%" + cmb_type.SelectedValue + "%'");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Pos.rpt.Sal_Report_itm_rpt.rdlc";
        ...
        private void chk_combitm_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_combitm.Checked)
            {
               // chk_combitm.Checked = false;
                chk_ibc.Checked = false;
            }
            else
            {
              //  chk_combitm.Checked = true;
              //  chk_ibc.Checked = true;
            }
        }

        private void chk_ibc_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_ibc.Checked)
            {
                chk_combitm.Checked = false;
