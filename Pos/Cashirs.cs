...
namespace POS.Pos
{
    public partial class Cashirs : BaseForm
    {
       // SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            ...
            if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        SqlDataAdapter da = new SqlDataAdapter("select * from whbins where wh_no='" + todel + "' and branch='" + BL.CLS_Session.brno + "'", con1);
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
          ...
          //  sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select c_brno ,c_slno,contr_id,contr_name from contrs where c_brno='" + BL.CLS_Session.brno + "' and contr_name like '%" + textBox1.Text + "%' order by contr_id", sqlConnection);
