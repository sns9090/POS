...
namespace POS.Sal
{
    public partial class Sal_Qst_Statment_Exp : BaseForm
    {
        ...
        public Sal_Qst_Statment_Exp(string aref,string sl)
        {
            InitializeComponent();
        ...
        {
            //SendKeys.Send("{Tab}");
            txt_code_Leave(sender, e);

            if (txt_code.Text == "")
            {
                MessageBox.Show(BL.CLS_Session.lang.Equals("E")?"Enter Customer Account":"يجب ادخال رقم الفاتورة", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_code.Focus();
                return;

            }
       // if(txt_code.Text !="")
                Load_Statment(txt_code.Text,cmb_salctr.SelectedValue.ToString());
...
//};
        ...
        private void Load_Statment(string aaref,string aasl)
        {
            /*
           // double sum = 0;
            double seso = 0;
                ...
                try
                {
                  ...
                  //  string condtx = txt_desc.Text;
                   //  dth = daml.SELECT_QUIRY_only_retrn_dt("select cu_name a_name,round(cu_opnbal,2) a_opnbal,cu_no a_key,whno from customers where cu_no='" + aakey + "' and cu_brno='" + BL.CLS_Session.brno + "'");
                    dth = daml.SELECT_QUIRY_only_retrn_dt("select a.text a_name,round((a.nettotal - isnull(a.invpaid,0) + (select isnull(sum(b.a_damt-b.a_camt),0) from acc_dtl b join acc_hdr c on c.a_brno=b.a_brno and c.a_ref=b.a_ref and c.a_type=b.a_type and c.sl_no=b.sl_no and c.pu_no=b.pu_no and c.a_mdate < '20210201' where b.a_brno='" + BL.CLS_Session.brno + "' and a.ref=" + aaref + " and a.invtype='04' and a.branch=b.a_brno and a.slcenter=b.sl_no and a.invtype=b.a_type and a.ref=b.a_ref)),2),a.ref,a.invtype  from sales_hdr a where a.ref=" + aaref + " and a.branch='" + BL.CLS_Session.brno + "' and a.slcenter='" + aasl + "' and a.invtype='04'");
                    ...
                    else
                    {
                       ...
                       // condcmb = chk_combin.Checked ? " and (a.cu_no='" + aaref + "' or " + condcmb2 : " and a.cu_no='" + aaref + "' ";
                        condt = cmb_salctr.SelectedIndex != -1 ? " and a.a_type = '" + cmb_salctr.SelectedValue.ToString() + "' " : " ";
                         ...
                         conddm = chk_d.Checked ? " and a.jddbcr='C' " : (chk_m.Checked ? " and a.jddbcr='D' " : " ");
                         qstr2 = "select a.a_type c1, a.a_ref c2, CONVERT(VARCHAR(10), CAST(a.a_mdate as date), 105) c3, (substring(a.a_hdate,7,2) + '-' + substring(a.a_hdate,5,2)+'-'+substring(a.a_hdate,1,4)) c4,a.a_text c5,round((case a.jddbcr when 'D' then a.a_damt else - a.a_camt end),2) c6,b.a_posted,a.a_type a_t,b.jhsrc src,b.sl_no sl,b.pu_no pu from acc_dtl a,acc_hdr b where a.a_brno=b.a_brno and a.a_ref=b.a_ref and a.a_type=b.a_type and a.sl_no=b.sl_no and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' and a.a_type in('02') and a.qst_ref=" + aaref + " and a.a_brno='" + BL.CLS_Session.brno + "' and a.qst_sl='" + aasl + "' and a.a_text like '%%' order by a.a_mdate,a.a_sysdate";
                       //  MessageBox.Show(qstr2);
                    }
                  //  dth = daml.SELECT_QUIRY_only_retrn_dt("select cu_name a_name,round(cu_opnbal,2) a_opnbal,cu_no a_key from customers where cu_no='" + aakey + "' and cu_brno='" + BL.CLS_Session.brno + "'");
                    ...
                    */
                    ...
                    {
                        if (Convert.ToBoolean(rw.Cells["a_p"].Value) == false && BL.CLS_Session.sysno.Equals("0"))
        ...
        private void dataGridView1_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F9)
            {
                ...
                if (dataGridView1.CurrentRow.Cells["src"].Value.Equals("Cus3"))
                {
                    Cus.Acc_Tran_QFK f4 = new Cus.Acc_Tran_QFK(dataGridView1.CurrentRow.Cells["a_t"].Value.ToString(), dataGridView1.CurrentRow.Cells["c2"].Value.ToString());
                    f4.MdiParent = ParentForm;
                    //if (BL.CLS_Session.formkey.Contains(f4.Tag.ToString()))
                        f4.Show();
                }
        ...
        private void cmb_type_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            //{
            //    cmb_salctr.SelectedValue.ToString().SelectedIndex = -1;
            //}
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
          ...
          ////  rf.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("details", dtprt));
            ...
            parameters[4] = new ReportParameter("cu_name", txt_desc.Text);
            parameters[5] = new ReportParameter("cur_bal", seso.ToString());
            BL.ToWord toWord = new BL.ToWord(Convert.ToDecimal(seso < 0 ? seso * -1 : seso), currencies[Convert.ToInt32(BL.CLS_Session.cur)]);
        ...
        {
            DataTable dt = daml.SELECT_QUIRY_only_retrn_dt("select * from sales_hdr where invpaid is not null and invpaid<>0 and invtype='04' and slcenter='" + cmb_salctr.SelectedValue + "' and branch='" + BL.CLS_Session.brno + "' and ref=" + txt_code.Text + "");
            if (dt.Rows.Count == 0)
            {
            ...
            else
            {
                ...
                txt_totl.Text = (Convert.ToDouble(dt.Rows[0]["nettotal"])).ToString();
                txt_pyd.Text=(Convert.ToDouble(dt.Rows[0]["invpaid"])).ToString();
            }
        }
    }
}
