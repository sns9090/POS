...
namespace POS.Sal
{
    public partial class SLcenters : BaseForm
    {
       // SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لا يمكن مسح مركز البيع الاساسي", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
          ...
          //  sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select sl_brno,sl_no,sl_name,dp_cashser,dp_slcash,dp_slcrdt,dp_reslcash,dp_reslcrdt,dp_descont,dp_taxacc,dp_mainwh,dp_rtrnwh,cstcode,dp_salcust_acc,dp_mkhzon_acc,is_shamel_tax,dp_diffser,srcst,dp_crdcardac,dp_cardcomm from slcenters where sl_brno='" + BL.CLS_Session.brno + "' and sl_name like '%" + textBox1.Text + "%' order by sl_no", sqlConnection);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[3] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[4] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[5] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[6] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[7] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[8] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[9] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[13] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[14] || dataGridView1.CurrentCell == dataGridView1.CurrentRow.Cells[16])
                {
