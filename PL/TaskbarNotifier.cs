...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		protected Font hoverContentFont = new Font("Arial",14,FontStyle.Regular,GraphicsUnit.Pixel);
		...
		public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
		{
			...
			switch (taskbarState)
			{
				...
				//	SetBounds(WorkAreaRectangle.Right-BackgroundBitmap.Width-17, WorkAreaRectangle.Bottom-1, BackgroundBitmap.Width, 0);
                    SetBounds(WorkAreaRectangle.Left - BackgroundBitmap.Width + 203, WorkAreaRectangle.Bottom -75, BackgroundBitmap.Width, 0);
				...
				case TaskbarStates.disappearing:
                    ...
                    //SetBounds(WorkAreaRectangle.Left - BackgroundBitmap.Width + 205, WorkAreaRectangle.Bottom - 1, BackgroundBitmap.Width, 0);
					SetBounds(WorkAreaRectangle.Left-BackgroundBitmap.Width + 203, WorkAreaRectangle.Bottom-BackgroundBitmap.Height-25, BackgroundBitmap.Width, BackgroundBitmap.Height);
                   // SetBounds(WorkAreaRectangle.Left - BackgroundBitmap.Width + 205, WorkAreaRectangle.Bottom - 1, BackgroundBitmap.Width, 0);
					timer.Interval = nVisibleEvents;
					timer.Start();
					Refresh();
