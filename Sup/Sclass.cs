...
namespace POS.Sup
{
    public partial class Sclass : BaseForm
    {
        ...
        private void Groups_Load(object sender, EventArgs e)
        {
            ...
            // sqlConnection.Open();
            sqlDataAdapter = new SqlDataAdapter("select cl_brno,cl_no,cl_desc,cl_acc from suclass where cl_brno='" + BL.CLS_Session.brno + "' and cl_desc like '%" + textBox1.Text + "%' order by cl_no", sqlConnection);
