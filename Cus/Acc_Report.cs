      ...
      //  DataTable dtt;
       ...
       // string typeno = "";
        ...
        private void SalesReport_Load(object sender, EventArgs e)
        {
           ...
           // var items = new[] { new { Text = "قيد عام", Value = "01" }, new { Text = "سند قبض", Value = "02" }, new { Text = "سند صرف", Value = "03" }, new { Text = "اشعار دائن", Value = "11" }, new { Text = "اشعار مدين", Value = "12" } };
