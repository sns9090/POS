...
namespace POS.Cus
{
    public partial class Acc_Report_col : BaseForm
    {
       ...
       // string typeno = "";
            ...
            try
            {
                ...
                */
                ...
                if (chk_all.Checked)
                {
                    ...
                    string condcol = rad_posted.Checked ? " and b.a_posted=1 " : (rad_notpostd.Checked ? " and b.a_posted=0 " : " ");
                   ...
                   // string qstr = "select a.sp_id sp_id,a.sp_name sp_name,(select isnull(sum(b.a_amt),0) from acc_hdr b where a.sp_id=b.jhcustno and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' ) sp_all,(select isnull(sum(b.a_amt * " + Math.Round(Convert.ToDouble(dtcolman.Rows[0]["sp_percent"]), 2) + "/100),0) from acc_hdr b where a.sp_id=b.jhcustno and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' ) sp_per from col_men a join acc_hdr b on a.sp_id=b.jhcustno where b.jhsrc like 'Cus%' and b.a_brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + " ";
                    string qstr = "select a.sp_id sp_id,a.sp_name sp_name,isnull(sum(b.a_amt),0) sp_all,isnull(sum(b.a_amt * " + Math.Round(Convert.ToDouble(dtcolman.Rows[0]["sp_percent"]), 2) + "/100),0) sp_per from col_men a join acc_hdr b on a.sp_id=b.jhcustno where b.jhsrc like 'Cus%' and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' and b.a_brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + " ";
                    ...
                    if (!string.IsNullOrEmpty(txt_equl.Text))
                    {
                        ...
                        qstr = qstr + " and b.a_amt " + comboBox2.Text.Substring(0, 1) + txt_equl.Text;
                    }

                    dt = daml.SELECT_QUIRY_only_retrn_dt(qstr + " and b.a_type like '%" + comboBox1.SelectedValue + "%' group by a.sp_id , a.sp_name");
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("يرجى اختيار محصل", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        cmb_colman.Focus();
                        return;
                    }
                    ...
                    */
                    ...
                    string condf = txt_fno.Text != "" ? txt_fno.Text : "1";
                    string condt = txt_tno.Text != "" ? txt_tno.Text : "999999999";
                    string condft = " and a.a_ref between " + condf + " and " + condt + " ";

                    string condp = rad_posted.Checked ? " and a.a_posted=1 " : (rad_notpostd.Checked ? " and a.a_posted=0 " : " ");
                    string condcol = rad_posted.Checked ? " and a.a_posted=1 " : (rad_notpostd.Checked ? " and a.a_posted=0 " : " ");

                    // string qstr = "select a.a_type a_type,cast(a.a_ref as varchar) a_ref,CONVERT(VARCHAR(10), CAST(a.a_mdate as date), 105) a_mdate,CONVERT(VARCHAR(10), CAST(a.a_hdate as date), 105) a_hdate,c.cu_name a_text,a.a_amt a_amt, round((a.a_amt * " + Math.Round(Convert.ToDouble(dtcolman.Rows[0]["sp_percent"]), 2) + "/100),2) per,a.a_posted,a.a_type a_t,a.jhsrc src from acc_hdr a left join acc_dtl b on a.a_brno=b.a_brno and a.a_type=b.a_type and a.a_ref=b.a_ref join customers c on b.cu_no=c.cu_name where a.jhsrc like 'Cus%' and a.a_brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' and a.jhcustno='" + cmb_colman.SelectedValue + "'";
                  //  string qstr = "select a.a_type a_type,cast(a.a_ref as varchar) a_ref,CONVERT(VARCHAR(10), CAST(a.a_mdate as date), 105) a_mdate,CONVERT(VARCHAR(10), CAST(a.a_hdate as date), 105) a_hdate,a.a_text a_text,a.a_amt a_amt, round((a.a_amt * " + Math.Round(Convert.ToDouble(dtcolman.Rows[0]["sp_percent"]), 2) + "/100),2) per,a.a_posted,a.a_type a_t,a.jhsrc src from acc_hdr a where a.jhsrc like 'Cus%' and a.a_brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' and a.jhcustno='" + cmb_colman.SelectedValue + "'";
                    string qstr = "select a.a_type a_type,cast(a.a_ref as varchar) a_ref,CONVERT(VARCHAR(10), CAST(a.a_mdate as date), 105) a_mdate,(substring(a.a_hdate,7,2) + '-' + substring(a.a_hdate,5,2)+'-'+substring(a.a_hdate,1,4)) a_hdate,a.a_text a_text,a.a_amt a_amt, round((a.a_amt * " + Math.Round(Convert.ToDouble(dtrvat[0]["sp_percent"]), 2) + "/100),2) per,a.a_posted,a.a_type a_t,a.jhsrc src from acc_hdr a where a.jhsrc like 'Cus%' and a.a_brno='" + BL.CLS_Session.brno + "' " + condp + usrname + condft + " and " + cond + " between '" + datval.convert_to_yyyyDDdd(txt_fdate.Text) + "' and '" + datval.convert_to_yyyyDDdd(txt_tdate.Text) + "' and a.jhcustno='" + cmb_colman.SelectedValue + "'";
                    ...
                    dt = daml.SELECT_QUIRY_only_retrn_dt(qstr + " and a.a_type like '%" + comboBox1.SelectedValue + "%'");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (chk_all.Checked)
            {
                ...
                try
                {
                    ...
                    rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Cus.rpt.Acc_Report_col_all_rpt.rdlc";
            ...
            else
            {
                ...
                try
                {
                    ...
                    rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Cus.rpt.Acc_Report_col_rpt.rdlc";
        ...
        private void dataGridView1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F9)
            {
                ...
                {
                    Cus.Acc_Tran f4 = new Cus.Acc_Tran(dataGridView1.CurrentRow.Cells["a_t"].Value.ToString(), dataGridView1.CurrentRow.Cells[1].Value.ToString());
                    f4.MdiParent = ParentForm;
                    if (BL.CLS_Session.formkey.Contains(f4.Tag.ToString()))
                        f4.Show();
                }
