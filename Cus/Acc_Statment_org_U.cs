...
namespace POS.Cus
{
    public partial class Acc_Statment_org_U : BaseForm
    {
       ...
       // double seso = 0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_code.Text != "")
                {
                    dtcust = daml.SELECT_QUIRY_only_retrn_dt("select cu_no from customers where cu_brno='" + BL.CLS_Session.brno + "' and cmncode='" + txt_code.Text + "'");
                    ...
                    */
                    ...
                    if (dth.Rows.Count > 0)
                    {
                       ...
                       // dr[8] = 0;
                        ...
                        txt_opnbal.Text = sumop.ToString();
                    }
