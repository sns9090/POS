...
namespace POS.Cus
{
    public partial class Acc_Statment_Exp_Life : BaseForm
    {
        ...
        public Acc_Statment_Exp_Life(string akey)
        {
            InitializeComponent();
...
//};
            ...
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                */
                ...
                workSheet.Range["D" + (dataGridView1.Rows.Count + 6).ToString(), "N" + (dataGridView1.Rows.Count + 6).ToString()].AutoFormat(Microsoft.Office.Interop.Excel.XlRangeAutoFormat.xlRangeAutoFormat3DEffects2);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
          ...
          // dataGridView2.DataSource = dt;
                ...
                if(BL.CLS_Session.lang.Equals("ع")) 
                    rf.reportViewer1.LocalReport.ReportEmbeddedResource = "POS.Cus.rpt.Acc_Statment_Exp_Life_rpt.rdlc";
                else
            ...
            if (aakey != "")
            {
                try
                {
                  ...
                  //  string condtx = txt_desc.Text;
                    ...
                    {
                        sum6 = sum6 + Convert.ToDouble(dtr[5]);
                        sum7 = sum7 + Convert.ToDouble(dtr[6]);
                        sum8 = sum8 + Convert.ToDouble(dtr[7]);
                        sum9 = sum9 + Convert.ToDouble(dtr[8]);
                        sum10 = sum10 + Convert.ToDouble(dtr[9]);
                        sum11 = sum11 + Convert.ToDouble(dtr[10]);
                        sum12 = sum12 + Convert.ToDouble(dtr[11]);
                        sum13 = sum13 + Convert.ToDouble(dtr[12]);
                       // sum14 = sum14 + Convert.ToDouble(dtr[13]);
                    }
                    dr[0] = "";
                    dr[1] = "";
                    dr[2] = "  -  -    ";
        ...
        private void dataGridView1_calculate()
        {
            for (int i = 0; i < dataGridView1.Rows.Count - 1; ++i)
            {
                ...
                {
                    seso = seso + Convert.ToDouble(dataGridView1.Rows[i].Cells["c6"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c7"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c8"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c9"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c10"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c11"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c12"].Value) + Convert.ToDouble(dataGridView1.Rows[i].Cells["c13"].Value);
                    dataGridView1.Rows[i].Cells["c14"].Value = Convert.ToDouble(seso);
