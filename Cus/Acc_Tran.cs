...
namespace POS.Cus
{
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (dataGridView1.CurrentCell == dataGridView1[0, dataGridView1.CurrentRow.Index])
                {
                    ...
                    SqlDataAdapter da2 = new SqlDataAdapter("select top 1 cu_no ,cu_name ,cl_acc from customers a join cuclass b on a.cu_class=b.cl_no where a.inactive=0 and a.cu_no = '" + dataGridView1.CurrentRow.Cells[0].Value + "' and a.cu_brno='" + BL.CLS_Session.brno + "'", con);
           ...
           // dtg = dataGridView1.DataSource;
            ...
            try
            {
                ...
                */
                ...
                // MessageBox.Show(tr);
                dttrtyps = daml.SELECT_QUIRY_only_retrn_dt("select * from trtypes where tr_no in(" + tr + ") and tr_no in('01','02','03','11','12','09')");
                ...
                string whatever = str2.Substring(str2.IndexOf("C122") + 5, 3);
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow dgvr in dataGridView1.Rows)
                {
                    ...
                    if (Convert.ToDouble(dgvr.Cells[4].Value) == 0 && Convert.ToDouble(dgvr.Cells[5].Value) == 0 && !dgvr.IsNewRow)
                    {
    ...
    */
                    if (!row.IsNewRow && !string.IsNullOrEmpty(row.Cells[0].Value.ToString() + row.Cells[1].Value.ToString()))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO acc_dtl(a_brno,a_type, a_ref, a_key, a_text, a_damt, a_camt, a_folio,a_mdate,a_hdate,jddbcr,cu_no,cc_no) VALUES(@a0,@a1,@a2,@a3,@a4,@a5,@a6,@a7,@a8,@a9,@a10,@a11,@a12)", con))
                        {
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!dthdr.Rows[0][8].ToString().Equals("Cus2"))
                {
        ...
        private void Fill_Data(string atype, string aref)
        {
            try
            {
              ...
              //  hdate = txt_hdate.Text.Replace("-", "").Substring(4, 4) + txt_hdate.Text.Replace("-", "").Substring(2, 2) + txt_hdate.Text.Replace("-", "").Substring(0, 2);
                ...
                dtdtl = daml.SELECT_QUIRY_only_retrn_dt("select  aa.cu_no cu_no,(case aa.cu_no when '' then aa.a_key else '' end) a_key,bb.a_name a_name,aa.a_text a_text,aa.a_damt a_damt,aa.a_camt a_camt,(case when aa.cu_no <> '' then aa.a_key else '' end) acc_key  from acc_dtl aa,accounts bb where aa.a_key=bb.a_key and aa.a_type='" + atype + "' and aa.a_ref=" + aref + " and aa.a_brno='" + BL.CLS_Session.brno + "' order by aa.a_folio");
