...
namespace POS.Cus
{
    public partial class Import_SC_From_Xls : BaseForm
    {
        string a_typ;
      ...
      //  BL.DAML daml =new BL.DAML();
        public Import_SC_From_Xls(string typ)
        {
            InitializeComponent();
            a_typ = typ;
        }
       ...
       // SqlConnection con = new SqlConnection(@"Provider=Microsoft.ACE.Sql.12.0;Data Source=" + Directory.GetCurrentDirectory() + @"\db\db.accdb; Jet Sql:Database Password=123456;");
            ...
            try
            {
                if (a_typ.Equals("Sup"))
                {
                    ...
                    for (int i = 0; i < dataGridView1.Rows.Count; i++)
                    {
                        ...
                        saveStaff = "INSERT into suppliers (su_no, su_brno, su_name, su_class, su_tel, su_addrs, su_opnbal, su_cntactp, su_crlmt, su_pymnt, vndr_taxcode,su_cur) "
                           ...
                           + " VALUES ('" + dataGridView1.Rows[i].Cells[0].Value.ToString().Trim() + "', '" + dataGridView1.Rows[i].Cells[1].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[2].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[3].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[4].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[5].Value.ToString().Trim() + "'," +Convert.ToDouble(dataGridView1.Rows[i].Cells[6].Value)*-1 + ",'" + dataGridView1.Rows[i].Cells[7].Value.ToString().Trim() + "'," + dataGridView1.Rows[i].Cells[8].Value + "," + dataGridView1.Rows[i].Cells[9].Value + ",'" + dataGridView1.Rows[i].Cells[10].Value.ToString().Trim() + "','');";
                ...
                else
                {
                    ...
                    for (int i = 0; i < dataGridView1.Rows.Count; i++)
                    {
                        ...
                        saveStaff = "INSERT into customers (cu_no, cu_brno, cu_name, cu_class, cu_tel, cu_addrs, cu_opnbal, cu_cntactp, cu_crlmt, cu_pymnt, vndr_taxcode,cf_fcy) "
                            //  + " VALUES ('" +(chk_autoitemno.Checked?dataGridView1.Rows[i].HeaderCell.Value.ToString() :  dataGridView1.Rows[i].Cells[0].Value.ToString().Trim().Substring(0, 16) )+ "', '" + dataGridView1.Rows[i].Cells[1].Value.ToString().Trim().Substring(0, 100) + "'," + dataGridView1.Rows[i].Cells[2].Value + ",'" +(chk_autobarcode.Checked?dataGridView1.Rows[i].HeaderCell.Value.ToString() : dataGridView1.Rows[i].Cells[3].Value.ToString().Trim().Substring(0, 20) )+ "'," + dataGridView1.Rows[i].Cells[4].Value + ",'" + dataGridView1.Rows[i].Cells[5].Value + "'," + dataGridView1.Rows[i].Cells[6].Value + "," + dataGridView1.Rows[i].Cells[7].Value + "," + dataGridView1.Rows[i].Cells[8].Value + ",'" + dataGridView1.Rows[i].Cells[9].Value.ToString().Trim() + "');";
                            //  + " VALUES ('" + dataGridView1.Rows[i].Cells[0].Value.ToString().Substring(0, 16) + "', '" + dataGridView1.Rows[i].Cells[1].Value.ToString().Substring(0, 100) + "'," + dataGridView1.Rows[i].Cells[2].Value + ",'" +  dataGridView1.Rows[i].Cells[3].Value.ToString().Substring(0, 20) + "'," + dataGridView1.Rows[i].Cells[4].Value + ",'" + dataGridView1.Rows[i].Cells[5].Value + "'," + dataGridView1.Rows[i].Cells[6].Value + "," + dataGridView1.Rows[i].Cells[7].Value + "," + dataGridView1.Rows[i].Cells[8].Value + ",'" + dataGridView1.Rows[i].Cells[9].Value.ToString() + "');";
                           + " VALUES ('" + dataGridView1.Rows[i].Cells[0].Value.ToString().Trim() + "', '" + dataGridView1.Rows[i].Cells[1].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[2].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[3].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[4].Value.ToString().Trim() + "','" + dataGridView1.Rows[i].Cells[5].Value.ToString().Trim() + "'," + dataGridView1.Rows[i].Cells[6].Value + ",'" + dataGridView1.Rows[i].Cells[7].Value.ToString().Trim() + "'," + dataGridView1.Rows[i].Cells[8].Value + "," + dataGridView1.Rows[i].Cells[9].Value + ",'" + dataGridView1.Rows[i].Cells[10].Value.ToString().Trim() + "','');";
        ...
        {
            this.Text = a_typ.Equals("Sup") ? "استيراد الموردين من اكسل" : "استيراد العملاء من اكسل";
        }
       ...
       //}
        ...
        {
            FileInfo fi = new FileInfo(Directory.GetCurrentDirectory() + @"\ImportCS.xlsx");
            if (fi.Exists)
            {
                System.Diagnostics.Process.Start(Directory.GetCurrentDirectory() + @"\ImportCS.xlsx");
            }
            else
            {
                //file doesn't exist
